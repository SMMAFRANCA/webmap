...
var format_ImvelPblico115unid_225 = new ol.format.GeoJSON();
var features_ImvelPblico115unid_225 = format_ImvelPblico115unid_225.readFeatures(json_ImvelPblico115unid_225, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImvelPblico115unid_225 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPblico115unid_225.addFeatures(features_ImvelPblico115unid_225);
var lyr_ImvelPblico115unid_225 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPblico115unid_225, 
                style: style_ImvelPblico115unid_225,
                popuplayertitle: 'Imóvel Público (115 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPblico115unid_225.png" /> Imóvel Público (115 unid.)'
            });
...
var group_PontosViciados = new ol.layer.Group({
                                layers: [lyr_LotesImvelPrivado56unid_224,lyr_ImvelPblico115unid_225,lyr_ImvelPrivado56unid_226,],
                                fold: 'close',
