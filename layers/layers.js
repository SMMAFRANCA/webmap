...
var format_LoteEMDEF10_21 = new ol.format.GeoJSON();
var features_LoteEMDEF10_21 = format_LoteEMDEF10_21.readFeatures(json_LoteEMDEF10_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LoteEMDEF10_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LoteEMDEF10_21.addFeatures(features_LoteEMDEF10_21);
var lyr_LoteEMDEF10_21 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LoteEMDEF10_21, 
                style: style_LoteEMDEF10_21,
                popuplayertitle: 'Lote EMDEF (10)',
                interactive: true,
                title: '<img src="styles/legend/LoteEMDEF10_21.png" /> Lote EMDEF (10)'
            });
var format_LoteEMDEF10_22 = new ol.format.GeoJSON();
var features_LoteEMDEF10_22 = format_LoteEMDEF10_22.readFeatures(json_LoteEMDEF10_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LoteEMDEF10_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LoteEMDEF10_22.addFeatures(features_LoteEMDEF10_22);
var lyr_LoteEMDEF10_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LoteEMDEF10_22, 
                style: style_LoteEMDEF10_22,
                popuplayertitle: 'Lote EMDEF (10)',
                interactive: true,
                title: '<img src="styles/legend/LoteEMDEF10_22.png" /> Lote EMDEF (10)'
            });
var format_Lote501_23 = new ol.format.GeoJSON();
var features_Lote501_23 = format_Lote501_23.readFeatures(json_Lote501_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Lote501_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lote501_23.addFeatures(features_Lote501_23);
var lyr_Lote501_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lote501_23, 
                style: style_Lote501_23,
                popuplayertitle: 'Lote (501)',
                interactive: true,
                title: '<img src="styles/legend/Lote501_23.png" /> Lote (501)'
            });
var format_Lote501_24 = new ol.format.GeoJSON();
var features_Lote501_24 = format_Lote501_24.readFeatures(json_Lote501_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Lote501_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lote501_24.addFeatures(features_Lote501_24);
var lyr_Lote501_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lote501_24, 
                style: style_Lote501_24,
                popuplayertitle: 'Lote (501)',
                interactive: true,
                title: '<img src="styles/legend/Lote501_24.png" /> Lote (501)'
            });
var format_reaVerde_25 = new ol.format.GeoJSON();
var features_reaVerde_25 = format_reaVerde_25.readFeatures(json_reaVerde_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_reaVerde_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_reaVerde_25.addFeatures(features_reaVerde_25);
var lyr_reaVerde_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_reaVerde_25, 
                style: style_reaVerde_25,
                popuplayertitle: 'Área Verde',
                interactive: true,
                title: '<img src="styles/legend/reaVerde_25.png" /> Área Verde'
            });
var format_reaPatrimonial_26 = new ol.format.GeoJSON();
var features_reaPatrimonial_26 = format_reaPatrimonial_26.readFeatures(json_reaPatrimonial_26, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_reaPatrimonial_26 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_reaPatrimonial_26.addFeatures(features_reaPatrimonial_26);
var lyr_reaPatrimonial_26 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_reaPatrimonial_26, 
                style: style_reaPatrimonial_26,
                popuplayertitle: 'Área Patrimonial',
                interactive: true,
                title: '<img src="styles/legend/reaPatrimonial_26.png" /> Área Patrimonial'
            });
var format_reaInstitucional_27 = new ol.format.GeoJSON();
var features_reaInstitucional_27 = format_reaInstitucional_27.readFeatures(json_reaInstitucional_27, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_reaInstitucional_27 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_reaInstitucional_27.addFeatures(features_reaInstitucional_27);
var lyr_reaInstitucional_27 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_reaInstitucional_27, 
                style: style_reaInstitucional_27,
                popuplayertitle: 'Área Institucional',
                interactive: true,
                title: '<img src="styles/legend/reaInstitucional_27.png" /> Área Institucional'
            });
var format_readeUsoEspecial_28 = new ol.format.GeoJSON();
var features_readeUsoEspecial_28 = format_readeUsoEspecial_28.readFeatures(json_readeUsoEspecial_28, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_readeUsoEspecial_28 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_readeUsoEspecial_28.addFeatures(features_readeUsoEspecial_28);
var lyr_readeUsoEspecial_28 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_readeUsoEspecial_28, 
                style: style_readeUsoEspecial_28,
                popuplayertitle: 'Área de Uso Especial',
                interactive: true,
                title: '<img src="styles/legend/readeUsoEspecial_28.png" /> Área de Uso Especial'
            });
var format_APP_29 = new ol.format.GeoJSON();
var features_APP_29 = format_APP_29.readFeatures(json_APP_29, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_APP_29 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_APP_29.addFeatures(features_APP_29);
var lyr_APP_29 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_APP_29, 
                style: style_APP_29,
                popuplayertitle: 'APP',
                interactive: true,
                title: '<img src="styles/legend/APP_29.png" /> APP'
            });
...
var format_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31 = new ol.format.GeoJSON();
var features_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31 = format_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31.readFeatures(json_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31.addFeatures(features_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31);
var lyr_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31, 
                style: style_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31,
                popuplayertitle: 'Antigo Aterro das Maritacas - Poços de Monitoramento 2ª Etapa (41)',
                interactive: true,
                title: '<img src="styles/legend/AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31.png" /> Antigo Aterro das Maritacas - Poços de Monitoramento 2ª Etapa (41)'
            });
...
var format_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33 = new ol.format.GeoJSON();
var features_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33 = format_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33.readFeatures(json_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33.addFeatures(features_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33);
var lyr_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33, 
                style: style_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33,
                popuplayertitle: 'Antigo Aterro das Maritacas - Poços de Monitoramento 1ª Etapa (28)',
                interactive: true,
                title: '<img src="styles/legend/AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33.png" /> Antigo Aterro das Maritacas - Poços de Monitoramento 1ª Etapa (28)'
            });
...
var format_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35 = new ol.format.GeoJSON();
var features_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35 = format_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35.readFeatures(json_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35.addFeatures(features_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35);
var lyr_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35, 
                style: style_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35,
                popuplayertitle: 'Área "B" da Fazenda Municipal - Poços de Monitoramento Engesolve (7)',
                interactive: true,
                title: '<img src="styles/legend/reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35.png" /> Área "B" da Fazenda Municipal - Poços de Monitoramento Engesolve (7)'
            });
...
var format_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37 = new ol.format.GeoJSON();
var features_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37 = format_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37.readFeatures(json_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37.addFeatures(features_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37);
var lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37, 
                style: style_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37,
                popuplayertitle: 'Antigo Aterro da Fazenda Municipal - Poços de Monitoramento AVATZ (6)',
                interactive: true,
                title: '<img src="styles/legend/AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37.png" /> Antigo Aterro da Fazenda Municipal - Poços de Monitoramento AVATZ (6)'
            });
var format_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38 = new ol.format.GeoJSON();
var features_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38 = format_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38.readFeatures(json_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38.addFeatures(features_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38);
var lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38, 
                style: style_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38,
                popuplayertitle: 'Antigo Aterro da Fazenda Municipal - Poços de Monitoramento (15)',
                interactive: true,
                title: '<img src="styles/legend/AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38.png" /> Antigo Aterro da Fazenda Municipal - Poços de Monitoramento (15)'
            });
var format_AoCivilPblica_39 = new ol.format.GeoJSON();
var features_AoCivilPblica_39 = format_AoCivilPblica_39.readFeatures(json_AoCivilPblica_39, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AoCivilPblica_39 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AoCivilPblica_39.addFeatures(features_AoCivilPblica_39);
var lyr_AoCivilPblica_39 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AoCivilPblica_39, 
                style: style_AoCivilPblica_39,
                popuplayertitle: 'Ação Civil Pública',
                interactive: true,
                title: '<img src="styles/legend/AoCivilPblica_39.png" /> Ação Civil Pública'
            });
var format_AoCivilPblica_40 = new ol.format.GeoJSON();
var features_AoCivilPblica_40 = format_AoCivilPblica_40.readFeatures(json_AoCivilPblica_40, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AoCivilPblica_40 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AoCivilPblica_40.addFeatures(features_AoCivilPblica_40);
var lyr_AoCivilPblica_40 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AoCivilPblica_40, 
                style: style_AoCivilPblica_40,
                popuplayertitle: 'Ação Civil Pública',
                interactive: true,
                title: '<img src="styles/legend/AoCivilPblica_40.png" /> Ação Civil Pública'
            });
var format_CartaAnuncia_41 = new ol.format.GeoJSON();
var features_CartaAnuncia_41 = format_CartaAnuncia_41.readFeatures(json_CartaAnuncia_41, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CartaAnuncia_41 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CartaAnuncia_41.addFeatures(features_CartaAnuncia_41);
var lyr_CartaAnuncia_41 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CartaAnuncia_41, 
                style: style_CartaAnuncia_41,
                popuplayertitle: 'Carta Anuência',
                interactive: true,
                title: '<img src="styles/legend/CartaAnuncia_41.png" /> Carta Anuência'
            });
var format_CartaAnuncia_42 = new ol.format.GeoJSON();
var features_CartaAnuncia_42 = format_CartaAnuncia_42.readFeatures(json_CartaAnuncia_42, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CartaAnuncia_42 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CartaAnuncia_42.addFeatures(features_CartaAnuncia_42);
var lyr_CartaAnuncia_42 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CartaAnuncia_42, 
                style: style_CartaAnuncia_42,
                popuplayertitle: 'Carta Anuência',
                interactive: true,
                title: '<img src="styles/legend/CartaAnuncia_42.png" /> Carta Anuência'
            });
var format_PlantioVoluntrio_43 = new ol.format.GeoJSON();
var features_PlantioVoluntrio_43 = format_PlantioVoluntrio_43.readFeatures(json_PlantioVoluntrio_43, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PlantioVoluntrio_43 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PlantioVoluntrio_43.addFeatures(features_PlantioVoluntrio_43);
var lyr_PlantioVoluntrio_43 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PlantioVoluntrio_43, 
                style: style_PlantioVoluntrio_43,
                popuplayertitle: 'Plantio Voluntário',
                interactive: true,
                title: '<img src="styles/legend/PlantioVoluntrio_43.png" /> Plantio Voluntário'
            });
var format_PlantioVoluntrio_44 = new ol.format.GeoJSON();
var features_PlantioVoluntrio_44 = format_PlantioVoluntrio_44.readFeatures(json_PlantioVoluntrio_44, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PlantioVoluntrio_44 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PlantioVoluntrio_44.addFeatures(features_PlantioVoluntrio_44);
var lyr_PlantioVoluntrio_44 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PlantioVoluntrio_44, 
                style: style_PlantioVoluntrio_44,
                popuplayertitle: 'Plantio Voluntário',
                interactive: true,
                title: '<img src="styles/legend/PlantioVoluntrio_44.png" /> Plantio Voluntário'
            });
var format_TACMinistrioPblico_45 = new ol.format.GeoJSON();
var features_TACMinistrioPblico_45 = format_TACMinistrioPblico_45.readFeatures(json_TACMinistrioPblico_45, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TACMinistrioPblico_45 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TACMinistrioPblico_45.addFeatures(features_TACMinistrioPblico_45);
var lyr_TACMinistrioPblico_45 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TACMinistrioPblico_45, 
                style: style_TACMinistrioPblico_45,
                popuplayertitle: 'TAC Ministério Público',
                interactive: true,
                title: '<img src="styles/legend/TACMinistrioPblico_45.png" /> TAC Ministério Público'
            });
var format_TACMinistrioPblico_46 = new ol.format.GeoJSON();
var features_TACMinistrioPblico_46 = format_TACMinistrioPblico_46.readFeatures(json_TACMinistrioPblico_46, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TACMinistrioPblico_46 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TACMinistrioPblico_46.addFeatures(features_TACMinistrioPblico_46);
var lyr_TACMinistrioPblico_46 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TACMinistrioPblico_46, 
                style: style_TACMinistrioPblico_46,
                popuplayertitle: 'TAC Ministério Público',
                interactive: true,
                title: '<img src="styles/legend/TACMinistrioPblico_46.png" /> TAC Ministério Público'
            });
var format_TCRACETESB_47 = new ol.format.GeoJSON();
var features_TCRACETESB_47 = format_TCRACETESB_47.readFeatures(json_TCRACETESB_47, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TCRACETESB_47 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TCRACETESB_47.addFeatures(features_TCRACETESB_47);
var lyr_TCRACETESB_47 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TCRACETESB_47, 
                style: style_TCRACETESB_47,
                popuplayertitle: 'TCRA CETESB',
                interactive: true,
                title: '<img src="styles/legend/TCRACETESB_47.png" /> TCRA CETESB'
            });
var format_TCRACETESB_48 = new ol.format.GeoJSON();
var features_TCRACETESB_48 = format_TCRACETESB_48.readFeatures(json_TCRACETESB_48, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TCRACETESB_48 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TCRACETESB_48.addFeatures(features_TCRACETESB_48);
var lyr_TCRACETESB_48 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TCRACETESB_48, 
                style: style_TCRACETESB_48,
                popuplayertitle: 'TCRA CETESB',
                interactive: true,
                title: '<img src="styles/legend/TCRACETESB_48.png" /> TCRA CETESB'
            });
var format_TCRAMunicipal_49 = new ol.format.GeoJSON();
var features_TCRAMunicipal_49 = format_TCRAMunicipal_49.readFeatures(json_TCRAMunicipal_49, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TCRAMunicipal_49 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TCRAMunicipal_49.addFeatures(features_TCRAMunicipal_49);
var lyr_TCRAMunicipal_49 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TCRAMunicipal_49, 
                style: style_TCRAMunicipal_49,
                popuplayertitle: 'TCRA Municipal',
                interactive: true,
                title: '<img src="styles/legend/TCRAMunicipal_49.png" /> TCRA Municipal'
            });
var format_TCRAMunicipal_50 = new ol.format.GeoJSON();
var features_TCRAMunicipal_50 = format_TCRAMunicipal_50.readFeatures(json_TCRAMunicipal_50, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TCRAMunicipal_50 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TCRAMunicipal_50.addFeatures(features_TCRAMunicipal_50);
var lyr_TCRAMunicipal_50 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TCRAMunicipal_50, 
                style: style_TCRAMunicipal_50,
                popuplayertitle: 'TCRA Municipal',
                interactive: true,
                title: '<img src="styles/legend/TCRAMunicipal_50.png" /> TCRA Municipal'
            });
var format_TRPRLCETESB_51 = new ol.format.GeoJSON();
var features_TRPRLCETESB_51 = format_TRPRLCETESB_51.readFeatures(json_TRPRLCETESB_51, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TRPRLCETESB_51 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TRPRLCETESB_51.addFeatures(features_TRPRLCETESB_51);
var lyr_TRPRLCETESB_51 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TRPRLCETESB_51, 
                style: style_TRPRLCETESB_51,
                popuplayertitle: 'TRPRL CETESB',
                interactive: true,
                title: '<img src="styles/legend/TRPRLCETESB_51.png" /> TRPRL CETESB'
            });
var format_TRPRLCETESB_52 = new ol.format.GeoJSON();
var features_TRPRLCETESB_52 = format_TRPRLCETESB_52.readFeatures(json_TRPRLCETESB_52, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TRPRLCETESB_52 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TRPRLCETESB_52.addFeatures(features_TRPRLCETESB_52);
var lyr_TRPRLCETESB_52 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TRPRLCETESB_52, 
                style: style_TRPRLCETESB_52,
                popuplayertitle: 'TRPRL CETESB',
                interactive: true,
                title: '<img src="styles/legend/TRPRLCETESB_52.png" /> TRPRL CETESB'
            });
...
var format_APP_69 = new ol.format.GeoJSON();
var features_APP_69 = format_APP_69.readFeatures(json_APP_69, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_APP_69 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_APP_69.addFeatures(features_APP_69);
var lyr_APP_69 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_APP_69, 
                style: style_APP_69,
                popuplayertitle: 'APP',
                interactive: true,
                title: '<img src="styles/legend/APP_69.png" /> APP'
            });
var format_RiosDuplos_70 = new ol.format.GeoJSON();
var features_RiosDuplos_70 = format_RiosDuplos_70.readFeatures(json_RiosDuplos_70, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RiosDuplos_70 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RiosDuplos_70.addFeatures(features_RiosDuplos_70);
var lyr_RiosDuplos_70 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RiosDuplos_70, 
                style: style_RiosDuplos_70,
                popuplayertitle: 'Rios Duplos',
                interactive: true,
                title: '<img src="styles/legend/RiosDuplos_70.png" /> Rios Duplos'
            });
var format_MassasDgua_71 = new ol.format.GeoJSON();
var features_MassasDgua_71 = format_MassasDgua_71.readFeatures(json_MassasDgua_71, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MassasDgua_71 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MassasDgua_71.addFeatures(features_MassasDgua_71);
var lyr_MassasDgua_71 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MassasDgua_71, 
                style: style_MassasDgua_71,
                popuplayertitle: 'Massas D\'água',
                interactive: true,
                title: '<img src="styles/legend/MassasDgua_71.png" /> Massas D\'água'
            });
var format_RiosSimples_72 = new ol.format.GeoJSON();
var features_RiosSimples_72 = format_RiosSimples_72.readFeatures(json_RiosSimples_72, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RiosSimples_72 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RiosSimples_72.addFeatures(features_RiosSimples_72);
var lyr_RiosSimples_72 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RiosSimples_72, 
                style: style_RiosSimples_72,
                popuplayertitle: 'Rios Simples',
                interactive: true,
                title: '<img src="styles/legend/RiosSimples_72.png" /> Rios Simples'
            });
var format_Nascentes_73 = new ol.format.GeoJSON();
var features_Nascentes_73 = format_Nascentes_73.readFeatures(json_Nascentes_73, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Nascentes_73 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Nascentes_73.addFeatures(features_Nascentes_73);
var lyr_Nascentes_73 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Nascentes_73, 
                style: style_Nascentes_73,
                popuplayertitle: 'Nascentes',
                interactive: true,
                title: '<img src="styles/legend/Nascentes_73.png" /> Nascentes'
            });
...
var format_JardimZoobotnicoPontosdeInteresse19_76 = new ol.format.GeoJSON();
var features_JardimZoobotnicoPontosdeInteresse19_76 = format_JardimZoobotnicoPontosdeInteresse19_76.readFeatures(json_JardimZoobotnicoPontosdeInteresse19_76, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_JardimZoobotnicoPontosdeInteresse19_76 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_JardimZoobotnicoPontosdeInteresse19_76.addFeatures(features_JardimZoobotnicoPontosdeInteresse19_76);
var lyr_JardimZoobotnicoPontosdeInteresse19_76 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_JardimZoobotnicoPontosdeInteresse19_76, 
                style: style_JardimZoobotnicoPontosdeInteresse19_76,
                popuplayertitle: 'Jardim Zoobotânico - Pontos de Interesse (19)',
                interactive: true,
                title: '<img src="styles/legend/JardimZoobotnicoPontosdeInteresse19_76.png" /> Jardim Zoobotânico - Pontos de Interesse (19)'
            });
...
var format_ProgramaAdoteUmaPraa284_111 = new ol.format.GeoJSON();
var features_ProgramaAdoteUmaPraa284_111 = format_ProgramaAdoteUmaPraa284_111.readFeatures(json_ProgramaAdoteUmaPraa284_111, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ProgramaAdoteUmaPraa284_111 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ProgramaAdoteUmaPraa284_111.addFeatures(features_ProgramaAdoteUmaPraa284_111);
var lyr_ProgramaAdoteUmaPraa284_111 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ProgramaAdoteUmaPraa284_111, 
                style: style_ProgramaAdoteUmaPraa284_111,
                popuplayertitle: 'Programa Adote Uma Praça (284)',
                interactive: true,
                title: '<img src="styles/legend/ProgramaAdoteUmaPraa284_111.png" /> Programa Adote Uma Praça (284)'
            });
var format_SemPlacaEgnaldo195384m_112 = new ol.format.GeoJSON();
var features_SemPlacaEgnaldo195384m_112 = format_SemPlacaEgnaldo195384m_112.readFeatures(json_SemPlacaEgnaldo195384m_112, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SemPlacaEgnaldo195384m_112 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SemPlacaEgnaldo195384m_112.addFeatures(features_SemPlacaEgnaldo195384m_112);
var lyr_SemPlacaEgnaldo195384m_112 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SemPlacaEgnaldo195384m_112, 
                style: style_SemPlacaEgnaldo195384m_112,
                popuplayertitle: 'Sem Placa - Egnaldo(1.953,84 m²)',
                interactive: true,
                title: '<img src="styles/legend/SemPlacaEgnaldo195384m_112.png" /> Sem Placa - Egnaldo(1.953,84 m²)'
            });
var format_SemPlacaDilu860267m_113 = new ol.format.GeoJSON();
var features_SemPlacaDilu860267m_113 = format_SemPlacaDilu860267m_113.readFeatures(json_SemPlacaDilu860267m_113, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SemPlacaDilu860267m_113 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SemPlacaDilu860267m_113.addFeatures(features_SemPlacaDilu860267m_113);
var lyr_SemPlacaDilu860267m_113 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SemPlacaDilu860267m_113, 
                style: style_SemPlacaDilu860267m_113,
                popuplayertitle: 'Sem Placa - Dilu (8.602,67 m²)',
                interactive: true,
                title: '<img src="styles/legend/SemPlacaDilu860267m_113.png" /> Sem Placa - Dilu (8.602,67 m²)'
            });
var format_ComPlacaEgnaldo6234740m_114 = new ol.format.GeoJSON();
var features_ComPlacaEgnaldo6234740m_114 = format_ComPlacaEgnaldo6234740m_114.readFeatures(json_ComPlacaEgnaldo6234740m_114, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ComPlacaEgnaldo6234740m_114 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ComPlacaEgnaldo6234740m_114.addFeatures(features_ComPlacaEgnaldo6234740m_114);
var lyr_ComPlacaEgnaldo6234740m_114 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ComPlacaEgnaldo6234740m_114, 
                style: style_ComPlacaEgnaldo6234740m_114,
                popuplayertitle: 'Com Placa - Egnaldo (62.347,40 m²)',
                interactive: true,
                title: '<img src="styles/legend/ComPlacaEgnaldo6234740m_114.png" /> Com Placa - Egnaldo (62.347,40 m²)'
            });
var format_ComPlacaDilu17521400m_115 = new ol.format.GeoJSON();
var features_ComPlacaDilu17521400m_115 = format_ComPlacaDilu17521400m_115.readFeatures(json_ComPlacaDilu17521400m_115, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ComPlacaDilu17521400m_115 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ComPlacaDilu17521400m_115.addFeatures(features_ComPlacaDilu17521400m_115);
var lyr_ComPlacaDilu17521400m_115 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ComPlacaDilu17521400m_115, 
                style: style_ComPlacaDilu17521400m_115,
                popuplayertitle: 'Com Placa - Dilu (175.214,00 m²)',
                interactive: true,
                title: '<img src="styles/legend/ComPlacaDilu17521400m_115.png" /> Com Placa - Dilu (175.214,00 m²)'
            });
var format_LotesImvelPrivado28_116 = new ol.format.GeoJSON();
var features_LotesImvelPrivado28_116 = format_LotesImvelPrivado28_116.readFeatures(json_LotesImvelPrivado28_116, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LotesImvelPrivado28_116 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LotesImvelPrivado28_116.addFeatures(features_LotesImvelPrivado28_116);
var lyr_LotesImvelPrivado28_116 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LotesImvelPrivado28_116, 
                style: style_LotesImvelPrivado28_116,
                popuplayertitle: 'Lotes - Imóvel Privado (28)',
                interactive: true,
                title: '<img src="styles/legend/LotesImvelPrivado28_116.png" /> Lotes - Imóvel Privado (28)'
            });
var format_ImvelPrivado32_117 = new ol.format.GeoJSON();
var features_ImvelPrivado32_117 = format_ImvelPrivado32_117.readFeatures(json_ImvelPrivado32_117, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImvelPrivado32_117 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPrivado32_117.addFeatures(features_ImvelPrivado32_117);
var lyr_ImvelPrivado32_117 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPrivado32_117, 
                style: style_ImvelPrivado32_117,
                popuplayertitle: 'Imóvel Privado (32)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPrivado32_117.png" /> Imóvel Privado (32)'
            });
var format_ImvelPblico107_118 = new ol.format.GeoJSON();
var features_ImvelPblico107_118 = format_ImvelPblico107_118.readFeatures(json_ImvelPblico107_118, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImvelPblico107_118 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPblico107_118.addFeatures(features_ImvelPblico107_118);
var lyr_ImvelPblico107_118 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPblico107_118, 
                style: style_ImvelPblico107_118,
                popuplayertitle: 'Imóvel Público (107)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPblico107_118.png" /> Imóvel Público (107)'
            });
var format_ResduosdeConstruoCivil7_119 = new ol.format.GeoJSON();
var features_ResduosdeConstruoCivil7_119 = format_ResduosdeConstruoCivil7_119.readFeatures(json_ResduosdeConstruoCivil7_119, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosdeConstruoCivil7_119 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosdeConstruoCivil7_119.addFeatures(features_ResduosdeConstruoCivil7_119);
var lyr_ResduosdeConstruoCivil7_119 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosdeConstruoCivil7_119, 
                style: style_ResduosdeConstruoCivil7_119,
                popuplayertitle: 'Resíduos de Construção Civil (7)',
                interactive: true,
                title: '<img src="styles/legend/ResduosdeConstruoCivil7_119.png" /> Resíduos de Construção Civil (7)'
            });
var format_ResduosVerdes1_120 = new ol.format.GeoJSON();
var features_ResduosVerdes1_120 = format_ResduosVerdes1_120.readFeatures(json_ResduosVerdes1_120, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosVerdes1_120 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosVerdes1_120.addFeatures(features_ResduosVerdes1_120);
var lyr_ResduosVerdes1_120 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosVerdes1_120, 
                style: style_ResduosVerdes1_120,
                popuplayertitle: 'Resíduos "Verdes" (1)',
                interactive: true,
                title: '<img src="styles/legend/ResduosVerdes1_120.png" /> Resíduos "Verdes" (1)'
            });
var format_ChapasdeRaioX1_121 = new ol.format.GeoJSON();
var features_ChapasdeRaioX1_121 = format_ChapasdeRaioX1_121.readFeatures(json_ChapasdeRaioX1_121, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ChapasdeRaioX1_121 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ChapasdeRaioX1_121.addFeatures(features_ChapasdeRaioX1_121);
var lyr_ChapasdeRaioX1_121 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ChapasdeRaioX1_121, 
                style: style_ChapasdeRaioX1_121,
                popuplayertitle: 'Chapas de Raio-X (1)',
                interactive: true,
                title: '<img src="styles/legend/ChapasdeRaioX1_121.png" /> Chapas de Raio-X (1)'
            });
var format_Embalagensvaziasdeagrotxicos1_122 = new ol.format.GeoJSON();
var features_Embalagensvaziasdeagrotxicos1_122 = format_Embalagensvaziasdeagrotxicos1_122.readFeatures(json_Embalagensvaziasdeagrotxicos1_122, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Embalagensvaziasdeagrotxicos1_122 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Embalagensvaziasdeagrotxicos1_122.addFeatures(features_Embalagensvaziasdeagrotxicos1_122);
var lyr_Embalagensvaziasdeagrotxicos1_122 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Embalagensvaziasdeagrotxicos1_122, 
                style: style_Embalagensvaziasdeagrotxicos1_122,
                popuplayertitle: 'Embalagens vazias de agrotóxicos (1)',
                interactive: true,
                title: '<img src="styles/legend/Embalagensvaziasdeagrotxicos1_122.png" /> Embalagens vazias de agrotóxicos (1)'
            });
var format_leodecozinhausado2_123 = new ol.format.GeoJSON();
var features_leodecozinhausado2_123 = format_leodecozinhausado2_123.readFeatures(json_leodecozinhausado2_123, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_leodecozinhausado2_123 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_leodecozinhausado2_123.addFeatures(features_leodecozinhausado2_123);
var lyr_leodecozinhausado2_123 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_leodecozinhausado2_123, 
                style: style_leodecozinhausado2_123,
                popuplayertitle: 'Óleo de cozinha usado (2)',
                interactive: true,
                title: '<img src="styles/legend/leodecozinhausado2_123.png" /> Óleo de cozinha usado (2)'
            });
var format_leolubrificanteusado1_124 = new ol.format.GeoJSON();
var features_leolubrificanteusado1_124 = format_leolubrificanteusado1_124.readFeatures(json_leolubrificanteusado1_124, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_leolubrificanteusado1_124 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_leolubrificanteusado1_124.addFeatures(features_leolubrificanteusado1_124);
var lyr_leolubrificanteusado1_124 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_leolubrificanteusado1_124, 
                style: style_leolubrificanteusado1_124,
                popuplayertitle: 'Óleo lubrificante usado (1)',
                interactive: true,
                title: '<img src="styles/legend/leolubrificanteusado1_124.png" /> Óleo lubrificante usado (1)'
            });
var format_Latasdetintametlicasvazias2_125 = new ol.format.GeoJSON();
var features_Latasdetintametlicasvazias2_125 = format_Latasdetintametlicasvazias2_125.readFeatures(json_Latasdetintametlicasvazias2_125, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Latasdetintametlicasvazias2_125 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Latasdetintametlicasvazias2_125.addFeatures(features_Latasdetintametlicasvazias2_125);
var lyr_Latasdetintametlicasvazias2_125 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Latasdetintametlicasvazias2_125, 
                style: style_Latasdetintametlicasvazias2_125,
                popuplayertitle: 'Latas de tinta metálicas vazias (2)',
                interactive: true,
                title: '<img src="styles/legend/Latasdetintametlicasvazias2_125.png" /> Latas de tinta metálicas vazias (2)'
            });
var format_ResduosPerigosos1_126 = new ol.format.GeoJSON();
var features_ResduosPerigosos1_126 = format_ResduosPerigosos1_126.readFeatures(json_ResduosPerigosos1_126, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosPerigosos1_126 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosPerigosos1_126.addFeatures(features_ResduosPerigosos1_126);
var lyr_ResduosPerigosos1_126 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosPerigosos1_126, 
                style: style_ResduosPerigosos1_126,
                popuplayertitle: 'Resíduos Perigosos (1)',
                interactive: true,
                title: '<img src="styles/legend/ResduosPerigosos1_126.png" /> Resíduos Perigosos (1)'
            });
var format_Madeiras1_127 = new ol.format.GeoJSON();
var features_Madeiras1_127 = format_Madeiras1_127.readFeatures(json_Madeiras1_127, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Madeiras1_127 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Madeiras1_127.addFeatures(features_Madeiras1_127);
var lyr_Madeiras1_127 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Madeiras1_127, 
                style: style_Madeiras1_127,
                popuplayertitle: 'Madeiras (1)',
                interactive: true,
                title: '<img src="styles/legend/Madeiras1_127.png" /> Madeiras (1)'
            });
var format_ResduosdeServiosdeSade21_128 = new ol.format.GeoJSON();
var features_ResduosdeServiosdeSade21_128 = format_ResduosdeServiosdeSade21_128.readFeatures(json_ResduosdeServiosdeSade21_128, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosdeServiosdeSade21_128 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosdeServiosdeSade21_128.addFeatures(features_ResduosdeServiosdeSade21_128);
var lyr_ResduosdeServiosdeSade21_128 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosdeServiosdeSade21_128, 
                style: style_ResduosdeServiosdeSade21_128,
                popuplayertitle: 'Resíduos de Serviços de Saúde (21)',
                interactive: true,
                title: '<img src="styles/legend/ResduosdeServiosdeSade21_128.png" /> Resíduos de Serviços de Saúde (21)'
            });
var format_PilhaseBaterias16_129 = new ol.format.GeoJSON();
var features_PilhaseBaterias16_129 = format_PilhaseBaterias16_129.readFeatures(json_PilhaseBaterias16_129, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PilhaseBaterias16_129 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PilhaseBaterias16_129.addFeatures(features_PilhaseBaterias16_129);
var lyr_PilhaseBaterias16_129 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PilhaseBaterias16_129, 
                style: style_PilhaseBaterias16_129,
                popuplayertitle: 'Pilhas e Baterias (16)',
                interactive: true,
                title: '<img src="styles/legend/PilhaseBaterias16_129.png" /> Pilhas e Baterias (16)'
            });
var format_Pneus1_130 = new ol.format.GeoJSON();
var features_Pneus1_130 = format_Pneus1_130.readFeatures(json_Pneus1_130, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Pneus1_130 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Pneus1_130.addFeatures(features_Pneus1_130);
var lyr_Pneus1_130 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Pneus1_130, 
                style: style_Pneus1_130,
                popuplayertitle: 'Pneus (1)',
                interactive: true,
                title: '<img src="styles/legend/Pneus1_130.png" /> Pneus (1)'
            });
var format_Lmpadas4_131 = new ol.format.GeoJSON();
var features_Lmpadas4_131 = format_Lmpadas4_131.readFeatures(json_Lmpadas4_131, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Lmpadas4_131 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lmpadas4_131.addFeatures(features_Lmpadas4_131);
var lyr_Lmpadas4_131 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lmpadas4_131, 
                style: style_Lmpadas4_131,
                popuplayertitle: 'Lâmpadas (4)',
                interactive: true,
                title: '<img src="styles/legend/Lmpadas4_131.png" /> Lâmpadas (4)'
            });
var format_ResduosdeCouro1_132 = new ol.format.GeoJSON();
var features_ResduosdeCouro1_132 = format_ResduosdeCouro1_132.readFeatures(json_ResduosdeCouro1_132, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosdeCouro1_132 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosdeCouro1_132.addFeatures(features_ResduosdeCouro1_132);
var lyr_ResduosdeCouro1_132 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosdeCouro1_132, 
                style: style_ResduosdeCouro1_132,
                popuplayertitle: 'Resíduos de Couro (1)',
                interactive: true,
                title: '<img src="styles/legend/ResduosdeCouro1_132.png" /> Resíduos de Couro (1)'
            });
var format_ResduosEletrnicos2_133 = new ol.format.GeoJSON();
var features_ResduosEletrnicos2_133 = format_ResduosEletrnicos2_133.readFeatures(json_ResduosEletrnicos2_133, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosEletrnicos2_133 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosEletrnicos2_133.addFeatures(features_ResduosEletrnicos2_133);
var lyr_ResduosEletrnicos2_133 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosEletrnicos2_133, 
                style: style_ResduosEletrnicos2_133,
                popuplayertitle: 'Resíduos Eletrônicos (2)',
                interactive: true,
                title: '<img src="styles/legend/ResduosEletrnicos2_133.png" /> Resíduos Eletrônicos (2)'
            });
var format_ResduosReciclveis15_134 = new ol.format.GeoJSON();
var features_ResduosReciclveis15_134 = format_ResduosReciclveis15_134.readFeatures(json_ResduosReciclveis15_134, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosReciclveis15_134 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosReciclveis15_134.addFeatures(features_ResduosReciclveis15_134);
var lyr_ResduosReciclveis15_134 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosReciclveis15_134, 
                style: style_ResduosReciclveis15_134,
                popuplayertitle: 'Resíduos Recicláveis (15)',
                interactive: true,
                title: '<img src="styles/legend/ResduosReciclveis15_134.png" /> Resíduos Recicláveis (15)'
            });
var format_ResduosInservveis4_135 = new ol.format.GeoJSON();
var features_ResduosInservveis4_135 = format_ResduosInservveis4_135.readFeatures(json_ResduosInservveis4_135, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResduosInservveis4_135 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResduosInservveis4_135.addFeatures(features_ResduosInservveis4_135);
var lyr_ResduosInservveis4_135 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResduosInservveis4_135, 
                style: style_ResduosInservveis4_135,
                popuplayertitle: 'Resíduos Inservíveis (4)',
                interactive: true,
                title: '<img src="styles/legend/ResduosInservveis4_135.png" /> Resíduos Inservíveis (4)'
            });
var format_Contineres286_136 = new ol.format.GeoJSON();
var features_Contineres286_136 = format_Contineres286_136.readFeatures(json_Contineres286_136, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Contineres286_136 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Contineres286_136.addFeatures(features_Contineres286_136);
var lyr_Contineres286_136 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Contineres286_136, 
                style: style_Contineres286_136,
                popuplayertitle: 'Contêineres (286)',
                interactive: true,
                title: '<img src="styles/legend/Contineres286_136.png" /> Contêineres (286)'
            });
var format_rvoreImuneaoCorte8_137 = new ol.format.GeoJSON();
var features_rvoreImuneaoCorte8_137 = format_rvoreImuneaoCorte8_137.readFeatures(json_rvoreImuneaoCorte8_137, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_rvoreImuneaoCorte8_137 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_rvoreImuneaoCorte8_137.addFeatures(features_rvoreImuneaoCorte8_137);
var lyr_rvoreImuneaoCorte8_137 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_rvoreImuneaoCorte8_137, 
                style: style_rvoreImuneaoCorte8_137,
                popuplayertitle: 'Árvore Imune ao Corte (8)',
                interactive: true,
                title: '<img src="styles/legend/rvoreImuneaoCorte8_137.png" /> Árvore Imune ao Corte (8)'
            });
var format_LocaisdeDifcilAcessoereasRurais20_138 = new ol.format.GeoJSON();
var features_LocaisdeDifcilAcessoereasRurais20_138 = format_LocaisdeDifcilAcessoereasRurais20_138.readFeatures(json_LocaisdeDifcilAcessoereasRurais20_138, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LocaisdeDifcilAcessoereasRurais20_138 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LocaisdeDifcilAcessoereasRurais20_138.addFeatures(features_LocaisdeDifcilAcessoereasRurais20_138);
var lyr_LocaisdeDifcilAcessoereasRurais20_138 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LocaisdeDifcilAcessoereasRurais20_138, 
                style: style_LocaisdeDifcilAcessoereasRurais20_138,
                popuplayertitle: 'Locais de Difícil Acesso e Áreas Rurais (20)',
                interactive: true,
                title: '<img src="styles/legend/LocaisdeDifcilAcessoereasRurais20_138.png" /> Locais de Difícil Acesso e Áreas Rurais (20)'
            });
var group_DescarteCorretodeResduos = new ol.layer.Group({
                                layers: [lyr_ResduosdeConstruoCivil7_119,lyr_ResduosVerdes1_120,lyr_ChapasdeRaioX1_121,lyr_Embalagensvaziasdeagrotxicos1_122,lyr_leodecozinhausado2_123,lyr_leolubrificanteusado1_124,lyr_Latasdetintametlicasvazias2_125,lyr_ResduosPerigosos1_126,lyr_Madeiras1_127,lyr_ResduosdeServiosdeSade21_128,lyr_PilhaseBaterias16_129,lyr_Pneus1_130,lyr_Lmpadas4_131,lyr_ResduosdeCouro1_132,lyr_ResduosEletrnicos2_133,lyr_ResduosReciclveis15_134,lyr_ResduosInservveis4_135,],
                                fold: 'close',
                                title: 'Descarte Correto de Resíduos'});
var group_PontosViciados139 = new ol.layer.Group({
                                layers: [lyr_LotesImvelPrivado28_116,lyr_ImvelPrivado32_117,lyr_ImvelPblico107_118,],
                                fold: 'close',
                                title: 'Pontos Viciados (139)'});
var group_ProgramaAdoteUmaPraa284 = new ol.layer.Group({
                                layers: [lyr_ProgramaAdoteUmaPraa284_111,lyr_SemPlacaEgnaldo195384m_112,lyr_SemPlacaDilu860267m_113,lyr_ComPlacaEgnaldo6234740m_114,lyr_ComPlacaDilu17521400m_115,],
                                fold: 'close',
                                title: 'Programa Adote Uma Praça (284)'});
...
var group_ParquesdeFranca6 = new ol.layer.Group({
                                layers: [lyr_JardimZoobotnicoDelimitao_74,lyr_JardimZoobotnicoTrajetos_75,lyr_JardimZoobotnicoPontosdeInteresse19_76,lyr_ParquedosTrabalhadores_77,lyr_ParquedosTrabalhadores_78,lyr_ComplexoPoliesportivo_79,lyr_ComplexoPoliesportivo_80,lyr_ParqueCaxambu_81,lyr_ParqueCaxambu_82,lyr_ParquedeExposiesFernandoCosta_83,lyr_ParquedeExposiesFernandoCosta_84,lyr_ParqueAmbientalLuprcioTaveira_85,lyr_ParqueAmbientalLuprcioTaveira_86,],
                                fold: 'close',
                                title: 'Parques de Franca (6)'});
var group_HidrografiaFBDS2025 = new ol.layer.Group({
                                layers: [lyr_APP_69,lyr_RiosDuplos_70,lyr_MassasDgua_71,lyr_RiosSimples_72,lyr_Nascentes_73,],
                                fold: 'close',
...
var group_reasCompromissadas = new ol.layer.Group({
                                layers: [lyr_AoCivilPblica_39,lyr_AoCivilPblica_40,lyr_CartaAnuncia_41,lyr_CartaAnuncia_42,lyr_PlantioVoluntrio_43,lyr_PlantioVoluntrio_44,lyr_TACMinistrioPblico_45,lyr_TACMinistrioPblico_46,lyr_TCRACETESB_47,lyr_TCRACETESB_48,lyr_TCRAMunicipal_49,lyr_TCRAMunicipal_50,lyr_TRPRLCETESB_51,lyr_TRPRLCETESB_52,],
                                fold: 'close',
                                title: 'Áreas Compromissadas'});
var group_GerenciamentodereasContaminadas4 = new ol.layer.Group({
                                layers: [lyr_ParqueZumbidosPalmares_30,lyr_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31,lyr_AntigoAterrodasMaritacas_32,lyr_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33,lyr_reaBdaFazendaMunicipalAntigareadoClubedeHipismo_34,lyr_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35,lyr_AntigoAterrodaFazendaMunicipal_36,lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37,lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38,],
                                fold: 'close',
                                title: 'Gerenciamento de Áreas Contaminadas (4)'});
var group_reasPblicas = new ol.layer.Group({
                                layers: [lyr_LoteEMDEF10_21,lyr_LoteEMDEF10_22,lyr_Lote501_23,lyr_Lote501_24,lyr_reaVerde_25,lyr_reaPatrimonial_26,lyr_reaInstitucional_27,lyr_readeUsoEspecial_28,lyr_APP_29,],
                                fold: 'close',
...
lyr_GoogleMaps_0.setVisible(false);lyr_GoogleSatellite_1.setVisible(true);lyr_GoogleSatelliteHybrid_2.setVisible(false);lyr_LimiteMunicipaldeFranca_3.setVisible(true);lyr_reaUrbanadeFranca_4.setVisible(true);lyr_RemanescentedaMatrcula11419_5.setVisible(false);lyr_ConjuntoHabitacional_6.setVisible(false);lyr_AvdeacessoaoHortoeColgioAgrcola_7.setVisible(false);lyr_reaK_8.setVisible(false);lyr_reaJ_9.setVisible(false);lyr_reaI_10.setVisible(false);lyr_reaH_11.setVisible(false);lyr_reaG_12.setVisible(false);lyr_reaF_13.setVisible(false);lyr_reaE_14.setVisible(false);lyr_reaD_15.setVisible(false);lyr_reaC_16.setVisible(false);lyr_reaB_17.setVisible(false);lyr_reaA_18.setVisible(false);lyr_reaAverbada355235ReservaFlorestalLegalPartedareaG_19.setVisible(false);lyr_reaaseraverbadaPartedareaG_20.setVisible(false);lyr_LoteEMDEF10_21.setVisible(false);lyr_LoteEMDEF10_22.setVisible(false);lyr_Lote501_23.setVisible(false);lyr_Lote501_24.setVisible(false);lyr_reaVerde_25.setVisible(false);lyr_reaPatrimonial_26.setVisible(false);lyr_reaInstitucional_27.setVisible(false);lyr_readeUsoEspecial_28.setVisible(false);lyr_APP_29.setVisible(false);lyr_ParqueZumbidosPalmares_30.setVisible(false);lyr_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31.setVisible(false);lyr_AntigoAterrodasMaritacas_32.setVisible(false);lyr_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33.setVisible(false);lyr_reaBdaFazendaMunicipalAntigareadoClubedeHipismo_34.setVisible(false);lyr_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35.setVisible(false);lyr_AntigoAterrodaFazendaMunicipal_36.setVisible(false);lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37.setVisible(false);lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38.setVisible(false);lyr_AoCivilPblica_39.setVisible(false);lyr_AoCivilPblica_40.setVisible(false);lyr_CartaAnuncia_41.setVisible(false);lyr_CartaAnuncia_42.setVisible(false);lyr_PlantioVoluntrio_43.setVisible(false);lyr_PlantioVoluntrio_44.setVisible(false);lyr_TACMinistrioPblico_45.setVisible(false);lyr_TACMinistrioPblico_46.setVisible(false);lyr_TCRACETESB_47.setVisible(false);lyr_TCRACETESB_48.setVisible(false);lyr_TCRAMunicipal_49.setVisible(false);lyr_TCRAMunicipal_50.setVisible(false);lyr_TRPRLCETESB_51.setVisible(false);lyr_TRPRLCETESB_52.setVisible(false);lyr_ARORemanescentesFlorestais_53.setVisible(false);lyr_AROreadeAmortecimento_54.setVisible(false);lyr_AROFaixadeCuestas_55.setVisible(false);lyr_AROAPP_56.setVisible(false);lyr_ARAIncongrunciasemAPP_57.setVisible(false);lyr_ARAETELagoas_58.setVisible(false);lyr_ARAAterros_59.setVisible(false);lyr_AODreaUrbanaConsolidada_60.setVisible(false);lyr_AODBaixaDensidadeNvel3_61.setVisible(false);lyr_AODBaixaDensidadeNvel2_62.setVisible(false);lyr_AODBaixaDensidadeNvel1_63.setVisible(false);lyr_AODAUSFase2_64.setVisible(false);lyr_AODAUSFase1_65.setVisible(false);lyr_LimitedaBaciadoRioCanoasLeiC4322024_66.setVisible(false);lyr_LimitedaBaciadoRioCanoasLeiC1002006_67.setVisible(false);lyr_DelimitaodaBaciadoRibeirodaOna_68.setVisible(false);lyr_APP_69.setVisible(false);lyr_RiosDuplos_70.setVisible(false);lyr_MassasDgua_71.setVisible(false);lyr_RiosSimples_72.setVisible(false);lyr_Nascentes_73.setVisible(false);lyr_JardimZoobotnicoDelimitao_74.setVisible(false);lyr_JardimZoobotnicoTrajetos_75.setVisible(false);lyr_JardimZoobotnicoPontosdeInteresse19_76.setVisible(false);lyr_ParquedosTrabalhadores_77.setVisible(false);lyr_ParquedosTrabalhadores_78.setVisible(false);lyr_ComplexoPoliesportivo_79.setVisible(false);lyr_ComplexoPoliesportivo_80.setVisible(false);lyr_ParqueCaxambu_81.setVisible(false);lyr_ParqueCaxambu_82.setVisible(false);lyr_ParquedeExposiesFernandoCosta_83.setVisible(false);lyr_ParquedeExposiesFernandoCosta_84.setVisible(false);lyr_ParqueAmbientalLuprcioTaveira_85.setVisible(false);lyr_ParqueAmbientalLuprcioTaveira_86.setVisible(false);lyr_R01S01_87.setVisible(false);lyr_R01S02_88.setVisible(false);lyr_R01S03_89.setVisible(false);lyr_R01S04_90.setVisible(false);lyr_R01S05_91.setVisible(false);lyr_R01S06_92.setVisible(false);lyr_R01S07_93.setVisible(false);lyr_R01S08_94.setVisible(false);lyr_R02S01_95.setVisible(false);lyr_R02S02_96.setVisible(false);lyr_R02S03_97.setVisible(false);lyr_R02S04_98.setVisible(false);lyr_R02S05_99.setVisible(false);lyr_R02S06_100.setVisible(false);lyr_R02S07_101.setVisible(false);lyr_R02S08_102.setVisible(false);lyr_R03S01_103.setVisible(false);lyr_R03S02_104.setVisible(false);lyr_R03S03_105.setVisible(false);lyr_R03S04_106.setVisible(false);lyr_R03S05_107.setVisible(false);lyr_R03S06_108.setVisible(false);lyr_R03S07_109.setVisible(false);lyr_R03S08_110.setVisible(false);lyr_ProgramaAdoteUmaPraa284_111.setVisible(false);lyr_SemPlacaEgnaldo195384m_112.setVisible(false);lyr_SemPlacaDilu860267m_113.setVisible(false);lyr_ComPlacaEgnaldo6234740m_114.setVisible(false);lyr_ComPlacaDilu17521400m_115.setVisible(false);lyr_LotesImvelPrivado28_116.setVisible(false);lyr_ImvelPrivado32_117.setVisible(false);lyr_ImvelPblico107_118.setVisible(false);lyr_ResduosdeConstruoCivil7_119.setVisible(false);lyr_ResduosVerdes1_120.setVisible(false);lyr_ChapasdeRaioX1_121.setVisible(false);lyr_Embalagensvaziasdeagrotxicos1_122.setVisible(false);lyr_leodecozinhausado2_123.setVisible(false);lyr_leolubrificanteusado1_124.setVisible(false);lyr_Latasdetintametlicasvazias2_125.setVisible(false);lyr_ResduosPerigosos1_126.setVisible(false);lyr_Madeiras1_127.setVisible(false);lyr_ResduosdeServiosdeSade21_128.setVisible(false);lyr_PilhaseBaterias16_129.setVisible(false);lyr_Pneus1_130.setVisible(false);lyr_Lmpadas4_131.setVisible(false);lyr_ResduosdeCouro1_132.setVisible(false);lyr_ResduosEletrnicos2_133.setVisible(false);lyr_ResduosReciclveis15_134.setVisible(false);lyr_ResduosInservveis4_135.setVisible(false);lyr_Contineres286_136.setVisible(false);lyr_rvoreImuneaoCorte8_137.setVisible(false);lyr_LocaisdeDifcilAcessoereasRurais20_138.setVisible(false);
var layersList = [group_MapasBase,lyr_LimiteMunicipaldeFranca_3,lyr_reaUrbanadeFranca_4,group_FazendaMunicipalPousoAlto,group_reasPblicas,group_GerenciamentodereasContaminadas4,group_reasCompromissadas,group_ZoneamentoAmbientaldaBaciadoRioCanoas,group_HidrografiaFBDS2025,group_ParquesdeFranca6,group_SubregiesContratoESSE,group_ProgramaAdoteUmaPraa284,group_PontosViciados139,group_DescarteCorretodeResduos,lyr_Contineres286_136,lyr_rvoreImuneaoCorte8_137,lyr_LocaisdeDifcilAcessoereasRurais20_138];
...
lyr_LoteEMDEF10_21.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', });
lyr_LoteEMDEF10_22.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', });
lyr_Lote501_23.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', });
lyr_Lote501_24.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', });
lyr_reaVerde_25.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', });
lyr_reaPatrimonial_26.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', });
lyr_reaInstitucional_27.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', });
lyr_readeUsoEspecial_28.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', });
lyr_APP_29.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', });
lyr_ParqueZumbidosPalmares_30.set('fieldAliases', {'fid': 'fid', 'Nome': 'Nome', 'Área (m²)': 'Área (m²)', });
lyr_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31.set('fieldAliases', {'fid': 'fid', 'Name': 'Poço', });
lyr_AntigoAterrodasMaritacas_32.set('fieldAliases', {'fid': 'fid', 'Nome': 'Nome', 'Área (m²)': 'Área (m²)', });
lyr_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33.set('fieldAliases', {'fid': 'fid', 'Poço': 'Poço', 'Norte (m)': 'Norte (m)', 'Este (m)': 'Este (m)', 'Cota': 'Cota', });
lyr_reaBdaFazendaMunicipalAntigareadoClubedeHipismo_34.set('fieldAliases', {'fid': 'fid', 'Nome': 'Nome', 'Área (m²)': 'Área (m²)', });
lyr_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35.set('fieldAliases', {'fid': 'fid', 'Norte': 'Norte', 'Leste': 'Leste', 'Cota': 'Cota', 'Identifica': 'Identifica', 'Profundida': 'Profundida', 'Identifi_1': 'Poço', 'Profundi_1': 'Profundi_1', 'NA Dinâmi': 'NA Dinâmi', 'NA Estatic': 'NA Estatic', 'NÍVEL DE': 'NÍVEL DE', 'TEMPERATUR': 'TEMPERATUR', 'pH': 'pH', 'CONDUTIVID': 'CONDUTIVID', 'Eh/ORP': 'Eh/ORP', 'OXIGÊNIO': 'OXIGÊNIO', 'TURBIDEZ': 'TURBIDEZ', });
lyr_AntigoAterrodaFazendaMunicipal_36.set('fieldAliases', {'fid': 'fid', 'Nome': 'Nome', 'Área (m²)': 'Área (m²)', });
lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37.set('fieldAliases', {'fid': 'fid', 'Field1': 'Poço', 'Field2': 'Field2', 'Field3': 'Field3', });
lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'Nome': 'Poço', });
lyr_AoCivilPblica_39.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'proc_municipal': 'Processo nº. (Municipal)', });
lyr_AoCivilPblica_40.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'area': 'area', 'quant': 'quant', 'proc_municipal': 'proc_municipal', });
lyr_CartaAnuncia_41.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'doc_origem': 'Documento de origem', });
lyr_CartaAnuncia_42.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'doc_origem': 'Documento de origem', });
lyr_PlantioVoluntrio_43.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'area': 'Área (m²)', 'quant': 'Quantidade de mudas', });
lyr_PlantioVoluntrio_44.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'area': 'Área (m²)', 'quant': 'Quantidade de mudas', });
lyr_TACMinistrioPblico_45.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'ic': 'Inquérito Civil nº.', 'proc_municipal': 'Processo nº. (Municipal)', });
lyr_TACMinistrioPblico_46.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'ic': 'Inquérito Civil nº.', 'proc_municipal': 'Processo nº. (Municipal)', });
lyr_TCRACETESB_47.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'proc_cetesb': 'Processo CETESB nº. (e-Ambiente)', });
lyr_TCRACETESB_48.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'proc_cetesb': 'Processo CETESB nº. (e-Ambiente)', });
lyr_TCRAMunicipal_49.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'autorizacao': 'Autorização nº. (Municipal)', });
lyr_TCRAMunicipal_50.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'autorizacao': 'Autorização nº. (Municipal)', });
lyr_TRPRLCETESB_51.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'matricula': 'Matrícula nº.', 'proc_cetesb': 'Processo CETESB nº. (e-Ambiente)', });
lyr_TRPRLCETESB_52.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'matricula': 'Matrícula nº.', 'proc_cetesb': 'Processo CETESB nº. (e-Ambiente)', });
...
lyr_APP_69.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'CLASSE HIDROLÓGICA', 'APP_M': 'APP (m)', 'AREA_HA': 'ÁREA (ha)', });
lyr_RiosDuplos_70.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'CLASSE HIDROLÓGICA', 'AREA_HA': 'ÁREA (ha)', });
lyr_MassasDgua_71.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'CLASSE HIDROLÓGICA', 'NATUREZA': 'NATUREZA', 'RIO': 'RIO', 'SETOR': 'SETOR', 'AREA_HA': 'ÁREA (ha)', });
lyr_RiosSimples_72.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'CLASSE HIDROLÓGICA', 'COMP_KM': 'EXTENSÃO (km)', });
lyr_Nascentes_73.set('fieldAliases', {'fid': 'fid', 'GEOCODIGO': 'GEOCODIGO', 'MUNICIPIO': 'MUNICIPIO', 'UF': 'UF', 'CD_UF': 'CD_UF', 'HIDRO': 'CLASSE HIDROLÓGICA', });
...
lyr_JardimZoobotnicoPontosdeInteresse19_76.set('fieldAliases', {'fid': 'fid', 'Legenda': 'Legenda', });
...
lyr_ProgramaAdoteUmaPraa284_111.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Área (m²)': 'Área (m²)', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', 'responsavel': 'Responsável', });
lyr_SemPlacaEgnaldo195384m_112.set('fieldAliases', {'fid': 'fid', 'Adotante': 'Adotante', 'Local': 'Local', 'Programa': 'Programa', 'Possui placa?': 'Possui placa?', 'm2': 'm2', 'responsavel': 'Responsável', });
lyr_SemPlacaDilu860267m_113.set('fieldAliases', {'fid': 'fid', 'Adotante': 'Adotante', 'Local': 'Local', 'Programa': 'Programa', 'Possui placa?': 'Possui placa?', 'm2': 'm2', 'responsavel': 'Responsável', });
lyr_ComPlacaEgnaldo6234740m_114.set('fieldAliases', {'fid': 'fid', 'Adotante': 'Adotante', 'Local': 'Local', 'Programa': 'Programa', 'Possui placa?': 'Possui placa?', 'm2': 'm2', 'responsavel': 'Responsável', });
lyr_ComPlacaDilu17521400m_115.set('fieldAliases', {'fid': 'fid', 'Adotante': 'Adotante', 'Local': 'Local', 'Programa': 'Programa', 'Possui placa?': 'Possui placa?', 'm2': 'm2', 'responsavel': 'Responsável', });
lyr_LotesImvelPrivado28_116.set('fieldAliases', {'fid': 'fid', 'quadra': 'QUADRA', 'lote': 'LOTE', 'cadastro_imobiliario': 'CADASTRO IMOBILIÁRIO', });
lyr_ImvelPrivado32_117.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'LONGITUDE': 'LONGITUDE', 'LATITUDE': 'LATITUDE', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'PROCESSO': 'PROCESSO', });
lyr_ImvelPblico107_118.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'LONGITUDE': 'LONGITUDE', 'LATITUDE': 'LATITUDE', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'PROCESSO': 'PROCESSO', });
lyr_ResduosdeConstruoCivil7_119.set('fieldAliases', {'fid': 'fid', 'categoria': 'categoria', 'local': 'local', 'descricao': 'Descrição', 'endereco': 'Endereço', 'contato': 'contato', });
lyr_ResduosVerdes1_120.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_ChapasdeRaioX1_121.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_Embalagensvaziasdeagrotxicos1_122.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_leodecozinhausado2_123.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_leolubrificanteusado1_124.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_Latasdetintametlicasvazias2_125.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_ResduosPerigosos1_126.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_Madeiras1_127.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_ResduosdeServiosdeSade21_128.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_PilhaseBaterias16_129.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_Pneus1_130.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_Lmpadas4_131.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_ResduosdeCouro1_132.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_ResduosEletrnicos2_133.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_ResduosReciclveis15_134.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_ResduosInservveis4_135.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
lyr_Contineres286_136.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'Name': 'Nome', });
lyr_rvoreImuneaoCorte8_137.set('fieldAliases', {'fid': 'fid', 'nome_popular': 'Nome Popular', 'nome_cientifico': 'Nome Científico', 'legislacao': 'Legislação', });
lyr_LocaisdeDifcilAcessoereasRurais20_138.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'PER__ODO_TURNO_': 'Período', 'HOR__RIO_DE_INICIO_DOS_SERVI__OS': 'Horário', 'FREQU__NCIA': 'Frequência', 'PROGRAMA____O_SEMANAL': 'Programação Semanal', 'EQUIPAMENTOS': 'Equipamentos', 'LONGITUDE': 'Longitude', 'LATITUDE': 'Latitude', });
...
lyr_LoteEMDEF10_21.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', });
lyr_LoteEMDEF10_22.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', });
lyr_Lote501_23.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', 'Código da Região': '', '1ª Semana': '', '2ª Semana': '', '3ª Semana': '', '4ª Semana': '', '5ª Semana': '', 'Terceirização': '', });
lyr_Lote501_24.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', 'Código da Região': '', '1ª Semana': '', '2ª Semana': '', '3ª Semana': '', '4ª Semana': '', '5ª Semana': '', 'Terceirização': '', });
lyr_reaVerde_25.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', 'Código da Região': '', '1ª Semana': '', '2ª Semana': '', '3ª Semana': '', '4ª Semana': '', '5ª Semana': '', 'Terceirização': '', });
lyr_reaPatrimonial_26.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', 'Código da Região': '', '1ª Semana': '', '2ª Semana': '', '3ª Semana': '', '4ª Semana': '', '5ª Semana': '', 'Terceirização': '', });
lyr_reaInstitucional_27.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', 'Código da Região': '', '1ª Semana': '', '2ª Semana': '', '3ª Semana': '', '4ª Semana': '', '5ª Semana': '', 'Terceirização': '', });
lyr_readeUsoEspecial_28.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', 'Código da Região': '', '1ª Semana': '', '2ª Semana': '', '3ª Semana': '', '4ª Semana': '', '5ª Semana': '', 'Terceirização': '', });
lyr_APP_29.set('fieldImages', {'fid': 'TextEdit', 'Classe': 'TextEdit', 'Área (m²)': 'TextEdit', 'Bairro': 'TextEdit', 'Nº Cadastro Imobiliário': 'TextEdit', 'Código da Região': 'TextEdit', '1ª Semana': 'TextEdit', '2ª Semana': 'TextEdit', '3ª Semana': 'TextEdit', '4ª Semana': 'TextEdit', '5ª Semana': 'TextEdit', 'Terceirização': 'TextEdit', });
lyr_ParqueZumbidosPalmares_30.set('fieldImages', {'fid': '', 'Nome': '', 'Área (m²)': '', });
lyr_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', });
lyr_AntigoAterrodasMaritacas_32.set('fieldImages', {'fid': '', 'Nome': '', 'Área (m²)': '', });
lyr_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33.set('fieldImages', {'fid': 'TextEdit', 'Poço': 'TextEdit', 'Norte (m)': 'TextEdit', 'Este (m)': 'TextEdit', 'Cota': 'TextEdit', });
lyr_reaBdaFazendaMunicipalAntigareadoClubedeHipismo_34.set('fieldImages', {'fid': '', 'Nome': '', 'Área (m²)': '', });
lyr_reaBdaFazendaMunicipalPoosdeMonitoramentoEngesolve7_35.set('fieldImages', {'fid': 'TextEdit', 'Norte': 'TextEdit', 'Leste': 'TextEdit', 'Cota': 'TextEdit', 'Identifica': 'TextEdit', 'Profundida': 'TextEdit', 'Identifi_1': 'TextEdit', 'Profundi_1': 'TextEdit', 'NA Dinâmi': 'TextEdit', 'NA Estatic': 'TextEdit', 'NÍVEL DE': 'TextEdit', 'TEMPERATUR': 'TextEdit', 'pH': 'TextEdit', 'CONDUTIVID': 'TextEdit', 'Eh/ORP': 'TextEdit', 'OXIGÊNIO': 'TextEdit', 'TURBIDEZ': 'TextEdit', });
lyr_AntigoAterrodaFazendaMunicipal_36.set('fieldImages', {'fid': '', 'Nome': '', 'Área (m²)': '', });
lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37.set('fieldImages', {'fid': 'TextEdit', 'Field1': 'TextEdit', 'Field2': 'TextEdit', 'Field3': 'TextEdit', });
lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'Nome': 'TextEdit', });
lyr_AoCivilPblica_39.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'area': 'TextEdit', 'quant': 'Range', 'proc_municipal': 'TextEdit', });
lyr_AoCivilPblica_40.set('fieldImages', {'fid': '', 'Name': '', 'area': '', 'quant': '', 'proc_municipal': '', });
lyr_CartaAnuncia_41.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'area': 'TextEdit', 'quant': 'Range', 'doc_origem': '', });
lyr_CartaAnuncia_42.set('fieldImages', {'fid': '', 'Name': '', 'area': '', 'quant': '', 'doc_origem': '', });
lyr_PlantioVoluntrio_43.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'area': 'TextEdit', 'quant': 'Range', });
lyr_PlantioVoluntrio_44.set('fieldImages', {'fid': '', 'Name': '', 'area': '', 'quant': '', });
lyr_TACMinistrioPblico_45.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'area': 'TextEdit', 'quant': 'Range', 'ic': 'TextEdit', 'proc_municipal': 'TextEdit', });
lyr_TACMinistrioPblico_46.set('fieldImages', {'fid': '', 'Name': '', 'area': '', 'quant': '', 'ic': '', 'proc_municipal': '', });
lyr_TCRACETESB_47.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'Area': '', 'quant': 'Range', 'proc_cetesb': '', });
lyr_TCRACETESB_48.set('fieldImages', {'fid': '', 'Name': '', 'Area': '', 'quant': '', 'proc_cetesb': '', });
lyr_TCRAMunicipal_49.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'Area': '', 'quant': 'Range', 'autorizacao': '', });
lyr_TCRAMunicipal_50.set('fieldImages', {'fid': '', 'Name': '', 'Area': '', 'quant': '', 'autorizacao': '', });
lyr_TRPRLCETESB_51.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'Area': '', 'matricula': '', 'proc_cetesb': '', });
lyr_TRPRLCETESB_52.set('fieldImages', {'fid': '', 'Name': '', 'Area': '', 'matricula': '', 'proc_cetesb': '', });
...
lyr_APP_69.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'APP_M': 'TextEdit', 'AREA_HA': 'TextEdit', });
lyr_RiosDuplos_70.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'AREA_HA': 'TextEdit', });
lyr_MassasDgua_71.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'NATUREZA': 'TextEdit', 'RIO': 'TextEdit', 'SETOR': 'TextEdit', 'AREA_HA': 'TextEdit', });
lyr_RiosSimples_72.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', 'COMP_KM': 'TextEdit', });
lyr_Nascentes_73.set('fieldImages', {'fid': 'TextEdit', 'GEOCODIGO': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'UF': 'TextEdit', 'CD_UF': 'Range', 'HIDRO': 'TextEdit', });
...
lyr_JardimZoobotnicoPontosdeInteresse19_76.set('fieldImages', {'fid': 'TextEdit', 'Legenda': 'TextEdit', });
...
lyr_ProgramaAdoteUmaPraa284_111.set('fieldImages', {'fid': '', 'Classe': '', 'Área (m²)': '', 'Bairro': '', 'Nº Cadastro Imobiliário': '', 'Código da Região': '', '1ª Semana': '', '2ª Semana': '', '3ª Semana': '', '4ª Semana': '', '5ª Semana': '', 'Terceirização': '', 'responsavel': '', });
lyr_SemPlacaEgnaldo195384m_112.set('fieldImages', {'fid': 'TextEdit', 'Adotante': 'TextEdit', 'Local': 'TextEdit', 'Programa': 'TextEdit', 'Possui placa?': 'TextEdit', 'm2': 'TextEdit', 'responsavel': 'TextEdit', });
lyr_SemPlacaDilu860267m_113.set('fieldImages', {'fid': 'TextEdit', 'Adotante': 'TextEdit', 'Local': 'TextEdit', 'Programa': 'TextEdit', 'Possui placa?': 'TextEdit', 'm2': 'TextEdit', 'responsavel': 'TextEdit', });
lyr_ComPlacaEgnaldo6234740m_114.set('fieldImages', {'fid': 'TextEdit', 'Adotante': 'TextEdit', 'Local': 'TextEdit', 'Programa': 'TextEdit', 'Possui placa?': 'TextEdit', 'm2': 'TextEdit', 'responsavel': 'TextEdit', });
lyr_ComPlacaDilu17521400m_115.set('fieldImages', {'fid': 'TextEdit', 'Adotante': 'TextEdit', 'Local': 'TextEdit', 'Programa': 'TextEdit', 'Possui placa?': 'TextEdit', 'm2': 'TextEdit', 'responsavel': 'TextEdit', });
lyr_LotesImvelPrivado28_116.set('fieldImages', {'fid': 'TextEdit', 'quadra': 'TextEdit', 'lote': 'TextEdit', 'cadastro_imobiliario': 'TextEdit', });
lyr_ImvelPrivado32_117.set('fieldImages', {'fid': '', 'BAIRRO': '', 'RUA': '', 'LONGITUDE': '', 'LATITUDE': '', 'CADASTRO IMOBILIÁRIO': '', 'CLASSIFICAÇÃO DO IMÓVEL': '', 'FREQUÊNCIA DE LIMPEZA': '', 'QUADRA': '', 'LOTE': '', 'PROCESSO': '', });
lyr_ImvelPblico107_118.set('fieldImages', {'fid': '', 'BAIRRO': '', 'RUA': '', 'LONGITUDE': '', 'LATITUDE': '', 'CADASTRO IMOBILIÁRIO': '', 'CLASSIFICAÇÃO DO IMÓVEL': '', 'FREQUÊNCIA DE LIMPEZA': '', 'QUADRA': '', 'LOTE': '', 'PROCESSO': '', });
lyr_ResduosdeConstruoCivil7_119.set('fieldImages', {'fid': '', 'categoria': '', 'local': '', 'descricao': '', 'endereco': '', 'contato': '', });
lyr_ResduosVerdes1_120.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_ChapasdeRaioX1_121.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_Embalagensvaziasdeagrotxicos1_122.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_leodecozinhausado2_123.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_leolubrificanteusado1_124.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_Latasdetintametlicasvazias2_125.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_ResduosPerigosos1_126.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_Madeiras1_127.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_ResduosdeServiosdeSade21_128.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_PilhaseBaterias16_129.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_Pneus1_130.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_Lmpadas4_131.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_ResduosdeCouro1_132.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_ResduosEletrnicos2_133.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_ResduosReciclveis15_134.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_ResduosInservveis4_135.set('fieldImages', {'fid': '', 'Categoria': '', 'Local': '', 'Descrição': '', 'Endereço': '', 'Contato': '', });
lyr_Contineres286_136.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'Name': 'TextEdit', });
lyr_rvoreImuneaoCorte8_137.set('fieldImages', {'fid': '', 'nome_popular': '', 'nome_cientifico': '', 'legislacao': '', });
lyr_LocaisdeDifcilAcessoereasRurais20_138.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'PER__ODO_TURNO_': 'TextEdit', 'HOR__RIO_DE_INICIO_DOS_SERVI__OS': 'TextEdit', 'FREQU__NCIA': 'TextEdit', 'PROGRAMA____O_SEMANAL': 'TextEdit', 'EQUIPAMENTOS': 'TextEdit', 'LONGITUDE': 'TextEdit', 'LATITUDE': 'TextEdit', });
...
lyr_LoteEMDEF10_21.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', });
lyr_LoteEMDEF10_22.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', });
lyr_Lote501_23.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'Terceirização': 'hidden field', });
lyr_Lote501_24.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'Terceirização': 'hidden field', });
lyr_reaVerde_25.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'Terceirização': 'hidden field', });
lyr_reaPatrimonial_26.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'Terceirização': 'hidden field', });
lyr_reaInstitucional_27.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'Terceirização': 'hidden field', });
lyr_readeUsoEspecial_28.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'hidden field', '1ª Semana': 'hidden field', '2ª Semana': 'hidden field', '3ª Semana': 'hidden field', '4ª Semana': 'hidden field', '5ª Semana': 'hidden field', 'Terceirização': 'hidden field', });
lyr_APP_29.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'Terceirização': 'hidden field', });
...
lyr_AntigoAterrodasMaritacasPoosdeMonitoramento2Etapa41_31.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', });
...
lyr_AntigoAterrodasMaritacasPoosdeMonitoramento1Etapa28_33.set('fieldLabels', {'fid': 'hidden field', 'Poço': 'inline label - visible with data', 'Norte (m)': 'hidden field', 'Este (m)': 'hidden field', 'Cota': 'hidden field', });
...
lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramentoAVATZ6_37.set('fieldLabels', {'fid': 'hidden field', 'Field1': 'inline label - visible with data', 'Field2': 'hidden field', 'Field3': 'hidden field', });
lyr_AntigoAterrodaFazendaMunicipalPoosdeMonitoramento15_38.set('fieldLabels', {'fid': 'hidden field', 'id': 'hidden field', 'Nome': 'inline label - visible with data', });
lyr_AoCivilPblica_39.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'proc_municipal': 'inline label - visible with data', });
lyr_AoCivilPblica_40.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'proc_municipal': 'inline label - visible with data', });
lyr_CartaAnuncia_41.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'doc_origem': 'inline label - visible with data', });
lyr_CartaAnuncia_42.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'doc_origem': 'inline label - visible with data', });
lyr_PlantioVoluntrio_43.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', });
lyr_PlantioVoluntrio_44.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', });
lyr_TACMinistrioPblico_45.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'ic': 'inline label - visible with data', 'proc_municipal': 'inline label - visible with data', });
lyr_TACMinistrioPblico_46.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'ic': 'inline label - visible with data', 'proc_municipal': 'inline label - visible with data', });
lyr_TCRACETESB_47.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'proc_cetesb': 'inline label - visible with data', });
lyr_TCRACETESB_48.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'proc_cetesb': 'inline label - visible with data', });
lyr_TCRAMunicipal_49.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'autorizacao': 'inline label - visible with data', });
lyr_TCRAMunicipal_50.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'autorizacao': 'inline label - visible with data', });
lyr_TRPRLCETESB_51.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'matricula': 'inline label - visible with data', 'proc_cetesb': 'inline label - visible with data', });
lyr_TRPRLCETESB_52.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'matricula': 'inline label - visible with data', 'proc_cetesb': 'inline label - visible with data', });
...
lyr_APP_69.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', 'APP_M': 'inline label - visible with data', 'AREA_HA': 'inline label - visible with data', });
lyr_RiosDuplos_70.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', 'AREA_HA': 'inline label - visible with data', });
lyr_MassasDgua_71.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', 'NATUREZA': 'inline label - visible with data', 'RIO': 'inline label - visible with data', 'SETOR': 'inline label - visible with data', 'AREA_HA': 'inline label - visible with data', });
lyr_RiosSimples_72.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'inline label - visible with data', 'HIDRO': 'inline label - visible with data', 'COMP_KM': 'inline label - visible with data', });
lyr_Nascentes_73.set('fieldLabels', {'fid': 'hidden field', 'GEOCODIGO': 'hidden field', 'MUNICIPIO': 'hidden field', 'UF': 'hidden field', 'CD_UF': 'hidden field', 'HIDRO': 'inline label - visible with data', });
...
lyr_JardimZoobotnicoPontosdeInteresse19_76.set('fieldLabels', {'fid': 'hidden field', 'Legenda': 'inline label - visible with data', });
...
lyr_ProgramaAdoteUmaPraa284_111.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Área (m²)': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'hidden field', '1ª Semana': 'hidden field', '2ª Semana': 'hidden field', '3ª Semana': 'hidden field', '4ª Semana': 'hidden field', '5ª Semana': 'hidden field', 'Terceirização': 'hidden field', 'responsavel': 'inline label - visible with data', });
lyr_SemPlacaEgnaldo195384m_112.set('fieldLabels', {'fid': 'hidden field', 'Adotante': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Programa': 'inline label - visible with data', 'Possui placa?': 'inline label - visible with data', 'm2': 'inline label - visible with data', 'responsavel': 'inline label - visible with data', });
lyr_SemPlacaDilu860267m_113.set('fieldLabels', {'fid': 'hidden field', 'Adotante': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Programa': 'inline label - visible with data', 'Possui placa?': 'inline label - visible with data', 'm2': 'inline label - visible with data', 'responsavel': 'inline label - visible with data', });
lyr_ComPlacaEgnaldo6234740m_114.set('fieldLabels', {'fid': 'hidden field', 'Adotante': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Programa': 'inline label - visible with data', 'Possui placa?': 'inline label - visible with data', 'm2': 'inline label - visible with data', 'responsavel': 'inline label - visible with data', });
lyr_ComPlacaDilu17521400m_115.set('fieldLabels', {'fid': 'hidden field', 'Adotante': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Programa': 'inline label - visible with data', 'Possui placa?': 'inline label - visible with data', 'm2': 'inline label - visible with data', 'responsavel': 'inline label - visible with data', });
lyr_LotesImvelPrivado28_116.set('fieldLabels', {'fid': 'hidden field', 'quadra': 'inline label - visible with data', 'lote': 'inline label - visible with data', 'cadastro_imobiliario': 'inline label - visible with data', });
lyr_ImvelPrivado32_117.set('fieldLabels', {'fid': 'hidden field', 'BAIRRO': 'inline label - visible with data', 'RUA': 'inline label - visible with data', 'LONGITUDE': 'hidden field', 'LATITUDE': 'hidden field', 'CADASTRO IMOBILIÁRIO': 'inline label - visible with data', 'CLASSIFICAÇÃO DO IMÓVEL': 'hidden field', 'FREQUÊNCIA DE LIMPEZA': 'hidden field', 'QUADRA': 'inline label - visible with data', 'LOTE': 'inline label - visible with data', 'PROCESSO': 'inline label - always visible', });
lyr_ImvelPblico107_118.set('fieldLabels', {'fid': 'hidden field', 'BAIRRO': 'inline label - visible with data', 'RUA': 'inline label - visible with data', 'LONGITUDE': 'hidden field', 'LATITUDE': 'hidden field', 'CADASTRO IMOBILIÁRIO': 'inline label - visible with data', 'CLASSIFICAÇÃO DO IMÓVEL': 'hidden field', 'FREQUÊNCIA DE LIMPEZA': 'inline label - visible with data', 'QUADRA': 'inline label - visible with data', 'LOTE': 'inline label - visible with data', 'PROCESSO': 'hidden field', });
lyr_ResduosdeConstruoCivil7_119.set('fieldLabels', {'fid': 'hidden field', 'categoria': 'inline label - visible with data', 'local': 'inline label - visible with data', 'descricao': 'inline label - visible with data', 'endereco': 'inline label - visible with data', 'contato': 'inline label - visible with data', });
lyr_ResduosVerdes1_120.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_ChapasdeRaioX1_121.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_Embalagensvaziasdeagrotxicos1_122.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_leodecozinhausado2_123.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_leolubrificanteusado1_124.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_Latasdetintametlicasvazias2_125.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_ResduosPerigosos1_126.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_Madeiras1_127.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_ResduosdeServiosdeSade21_128.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_PilhaseBaterias16_129.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_Pneus1_130.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_Lmpadas4_131.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_ResduosdeCouro1_132.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_ResduosEletrnicos2_133.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_ResduosReciclveis15_134.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_ResduosInservveis4_135.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
lyr_Contineres286_136.set('fieldLabels', {'fid': 'hidden field', 'id': 'hidden field', 'Name': 'inline label - visible with data', });
lyr_rvoreImuneaoCorte8_137.set('fieldLabels', {'fid': 'hidden field', 'nome_popular': 'inline label - visible with data', 'nome_cientifico': 'inline label - visible with data', 'legislacao': 'inline label - visible with data', });
lyr_LocaisdeDifcilAcessoereasRurais20_138.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'PER__ODO_TURNO_': 'inline label - visible with data', 'HOR__RIO_DE_INICIO_DOS_SERVI__OS': 'inline label - visible with data', 'FREQU__NCIA': 'inline label - visible with data', 'PROGRAMA____O_SEMANAL': 'inline label - visible with data', 'EQUIPAMENTOS': 'inline label - visible with data', 'LONGITUDE': 'inline label - visible with data', 'LATITUDE': 'inline label - visible with data', });
lyr_LocaisdeDifcilAcessoereasRurais20_138.on('precompose', function(evt) {
