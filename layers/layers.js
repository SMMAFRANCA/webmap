...
var format_LotesImvelPrivado64unid_233 = new ol.format.GeoJSON();
var features_LotesImvelPrivado64unid_233 = format_LotesImvelPrivado64unid_233.readFeatures(json_LotesImvelPrivado64unid_233, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_LotesImvelPrivado64unid_233 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LotesImvelPrivado64unid_233.addFeatures(features_LotesImvelPrivado64unid_233);
var lyr_LotesImvelPrivado64unid_233 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LotesImvelPrivado64unid_233, 
                style: style_LotesImvelPrivado64unid_233,
                popuplayertitle: 'Lotes - Imóvel Privado (64 unid.)',
                interactive: true,
                title: '<img src="styles/legend/LotesImvelPrivado64unid_233.png" /> Lotes - Imóvel Privado (64 unid.)'
            });
var format_ImvelPblico114unid_234 = new ol.format.GeoJSON();
var features_ImvelPblico114unid_234 = format_ImvelPblico114unid_234.readFeatures(json_ImvelPblico114unid_234, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_ImvelPblico114unid_234 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPblico114unid_234.addFeatures(features_ImvelPblico114unid_234);
var lyr_ImvelPblico114unid_234 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPblico114unid_234, 
                style: style_ImvelPblico114unid_234,
                popuplayertitle: 'Imóvel Público (114 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPblico114unid_234.png" /> Imóvel Público (114 unid.)'
            });
var format_ImvelPrivado64unid_235 = new ol.format.GeoJSON();
var features_ImvelPrivado64unid_235 = format_ImvelPrivado64unid_235.readFeatures(json_ImvelPrivado64unid_235, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_ImvelPrivado64unid_235 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPrivado64unid_235.addFeatures(features_ImvelPrivado64unid_235);
var lyr_ImvelPrivado64unid_235 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPrivado64unid_235, 
                style: style_ImvelPrivado64unid_235,
                popuplayertitle: 'Imóvel Privado (64 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPrivado64unid_235.png" /> Imóvel Privado (64 unid.)'
            });
...
var group_PontosViciados = new ol.layer.Group({
                                layers: [lyr_LotesImvelPrivado64unid_233,lyr_ImvelPblico114unid_234,lyr_ImvelPrivado64unid_235,],
                                fold: 'close',
...
lyr_LotesImvelPrivado64unid_233.set('fieldAliases', {'fid': 'fid', 'quadra': 'QUADRA', 'lote': 'LOTE', 'cadastro_imobiliario': 'CADASTRO IMOBILIÁRIO', });
lyr_ImvelPblico114unid_234.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'processo_seinfra': 'Processo SEINFRA', 'processo_sms': 'Processo SMS', 'processo_mp': 'Pocesso MP', 'processo_smseg': 'Processo SMSEG', 'coordenada_x': 'Coordenada Leste (x)', 'coordenada_y': 'Coordenada Norte (y)', 'outros_processos': 'Outos Processos', });
lyr_ImvelPrivado64unid_235.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'processo_seinfra': 'Processo SEINFRA', 'processo_sms': 'Processo SMS', 'processo_mp': 'Pocesso MP', 'processo_smseg': 'Processo SMSEG', 'coordenada_x': 'Coordenada Leste (x)', 'coordenada_y': 'Coordenada Norte (y)', 'outros_processos': 'Outos Processos', });
