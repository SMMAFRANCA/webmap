...
var format_readeUsoEspecial276unid271190268m_327 = new ol.format.GeoJSON();
var features_readeUsoEspecial276unid271190268m_327 = format_readeUsoEspecial276unid271190268m_327.readFeatures(json_readeUsoEspecial276unid271190268m_327, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_readeUsoEspecial276unid271190268m_327 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_readeUsoEspecial276unid271190268m_327.addFeatures(features_readeUsoEspecial276unid271190268m_327);
var lyr_readeUsoEspecial276unid271190268m_327 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_readeUsoEspecial276unid271190268m_327, 
                style: style_readeUsoEspecial276unid271190268m_327,
                popuplayertitle: 'Área de Uso Especial (276 unid. / 2.711.902,68 m²)',
                interactive: true,
                title: '<img src="styles/legend/readeUsoEspecial276unid271190268m_327.png" /> Área de Uso Especial (276 unid. / 2.711.902,68 m²)'
            });
...
var format_LoteamentoFechado115unid52603608m_330 = new ol.format.GeoJSON();
var features_LoteamentoFechado115unid52603608m_330 = format_LoteamentoFechado115unid52603608m_330.readFeatures(json_LoteamentoFechado115unid52603608m_330, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_LoteamentoFechado115unid52603608m_330 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LoteamentoFechado115unid52603608m_330.addFeatures(features_LoteamentoFechado115unid52603608m_330);
var lyr_LoteamentoFechado115unid52603608m_330 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LoteamentoFechado115unid52603608m_330, 
                style: style_LoteamentoFechado115unid52603608m_330,
                popuplayertitle: 'Loteamento Fechado (115 unid. / 526.036,08 m²)',
                interactive: true,
                title: '<img src="styles/legend/LoteamentoFechado115unid52603608m_330.png" /> Loteamento Fechado (115 unid. / 526.036,08 m²)'
            });
var format_reaVerde1946unid805735618m_331 = new ol.format.GeoJSON();
var features_reaVerde1946unid805735618m_331 = format_reaVerde1946unid805735618m_331.readFeatures(json_reaVerde1946unid805735618m_331, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_reaVerde1946unid805735618m_331 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_reaVerde1946unid805735618m_331.addFeatures(features_reaVerde1946unid805735618m_331);
var lyr_reaVerde1946unid805735618m_331 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_reaVerde1946unid805735618m_331, 
                style: style_reaVerde1946unid805735618m_331,
                popuplayertitle: 'Área Verde (1.946 unid. / 8.057.356,18 m²)',
                interactive: true,
                title: '<img src="styles/legend/reaVerde1946unid805735618m_331.png" /> Área Verde (1.946 unid. / 8.057.356,18 m²)'
            });
...
var format_TCRACETESBPARCELAMENTO23unid_350 = new ol.format.GeoJSON();
var features_TCRACETESBPARCELAMENTO23unid_350 = format_TCRACETESBPARCELAMENTO23unid_350.readFeatures(json_TCRACETESBPARCELAMENTO23unid_350, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_TCRACETESBPARCELAMENTO23unid_350 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TCRACETESBPARCELAMENTO23unid_350.addFeatures(features_TCRACETESBPARCELAMENTO23unid_350);
var lyr_TCRACETESBPARCELAMENTO23unid_350 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TCRACETESBPARCELAMENTO23unid_350, 
                style: style_TCRACETESBPARCELAMENTO23unid_350,
                popuplayertitle: 'TCRA CETESB / PARCELAMENTO (23 unid.)',
                interactive: true,
                title: '<img src="styles/legend/TCRACETESBPARCELAMENTO23unid_350.png" /> TCRA CETESB / PARCELAMENTO (23 unid.)'
            });
...
var group_reasCompromissadas = new ol.layer.Group({
                                layers: [lyr_TRPRLCETESB2unid_346,lyr_TRPRLCETESB2unid_347,lyr_TCRAMunicipal14unid_348,lyr_TCRAMunicipal14unid_349,lyr_TCRACETESBPARCELAMENTO23unid_350,lyr_TCRACETESBPARCELAMENTO23unid_351,lyr_TCRACETESB28unid_352,lyr_TCRACETESB28unid_353,lyr_TACMinistrioPblico9unid_354,lyr_TACMinistrioPblico9unid_355,lyr_PlantioVoluntrio1unid_356,lyr_PlantioVoluntrio1unid_357,lyr_CartaAnuncia20unid_358,lyr_CartaAnuncia20unid_359,lyr_AoCivilPblica1unid_360,lyr_AoCivilPblica1unid_361,],
                                fold: 'close',
                                title: 'Áreas Compromissadas'});
var group_reasPblicas = new ol.layer.Group({
                                layers: [lyr_APP156unid230392892m_326,lyr_readeUsoEspecial276unid271190268m_327,lyr_reaInstitucional224unid133042345m_328,lyr_reaPatrimonial33unid15776685m_329,lyr_LoteamentoFechado115unid52603608m_330,lyr_reaVerde1946unid805735618m_331,lyr_Lote251unid7505210m_332,lyr_Lote251unid_333,lyr_LoteEdificao20unid508062m_334,lyr_LoteEdificao20unid_335,lyr_LeiloLEIN97542025Homologado4unid334770m_336,lyr_LeiloLEIN97542025Homologado4unid_337,lyr_LeiloLEIN97542025Proc35162004100002652520256922unid352000m_338,lyr_LeiloLEIN97542025Proc35162004100002652520256922unid_339,lyr_LeiloLEIN97542025Proc351620041000007954202537196unid3240462m_340,lyr_LeiloLEIN97542025Proc351620041000007954202537196unid_341,lyr_LeiloLEIN97542025Proc35162004100002198620254518unid2092083m_342,lyr_LeiloLEIN97542025Proc35162004100002198620254518unid_343,lyr_LoteEMDEF10unid218783m_344,lyr_LoteEMDEF10unid_345,],
                                fold: 'close',
...
lyr_ARORemanescentesFlorestais_5.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AROreadeAmortecimento_6.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AROFaixadeCuestas_7.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AROAPP_8.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_ARAIncongrunciasemAPP_9.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_ARAETELagoas_10.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_ARAAterros_11.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AODreaUrbanaConsolidada_12.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AODBaixaDensidadeNvel3_13.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AODBaixaDensidadeNvel2_14.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AODBaixaDensidadeNvel1_15.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Classe', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'SUM_area', 'FIRST_AI': 'FIRST_AI', 'layer': 'layer', 'path': 'path', });
lyr_AODAUSFase2_16.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Subclasse', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'Área (m²)', 'FIRST_AI': 'Classe', 'layer': 'layer', 'path': 'path', });
lyr_AODAUSFase1_17.set('fieldAliases', {'fid': 'fid', 'Subclasse': 'Subclasse', 'Área (m²': 'Área (m²', 'Classe': 'Subclasse', 'desc_subcl': 'desc_subcl', 'desc_class': 'desc_class', 'SUM_area': 'Área (m²)', 'FIRST_AI': 'Classe', 'layer': 'layer', 'path': 'path', });
...
lyr_ParqueAmbientalLuprcioTaveira_87.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParqueAmbientalLuprcioTaveira_88.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParqueAmbientalSebastioAlvesBranquinhoBosquedosAngicos_89.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParqueAmbientalSebastioAlvesBranquinhoBosquedosAngicos_90.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParquedeExposiesFernandoCosta_91.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParquedeExposiesFernandoCosta_92.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParqueCaxambu_93.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParqueCaxambu_94.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ComplexoPoliesportivo_95.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ComplexoPoliesportivo_96.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParquedosTrabalhadores_97.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_ParquedosTrabalhadores_98.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_JardimZoobotnico_99.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
lyr_JardimZoobotnico_100.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'descriptio': 'descriptio', 'Nome': 'Nome', 'Descriçã': 'Descriçã', 'layer': 'layer', 'path': 'path', });
...
lyr_ClasseVB_307.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseVA_308.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseIVC_309.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseIVB_310.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseIVA_311.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseIIIC_312.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseIIIB_313.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseIIIA_314.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseII_315.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
lyr_ClasseI_316.set('fieldAliases', {'fid': 'fid', 'classe': 'classe', 'risco_eros': 'risco_eros', 'suscetibil': 'suscetibil', 'uso_solo': 'uso_solo', 'setores_re': 'setores_re', 'solos_pred': 'solos_pred', 'substrato_': 'substrato_', 'processos_': 'processos_', 'recomendac': 'recomendac', });
...
lyr_readeUsoEspecial276unid271190268m_327.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'descricao': 'descricao', 'm2': 'm2', 'data_inclusao': 'Data de Inclusão', 'status_leilao': 'Região', 'processo': 'processo', });
...
lyr_LoteamentoFechado115unid52603608m_330.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'descricao': 'descricao', 'm2': 'm2', 'data_inclusao': 'Data de Inclusão', 'status_leilao': 'Região', 'processo': 'processo', });
lyr_reaVerde1946unid805735618m_331.set('fieldAliases', {'fid': 'fid', 'Classe': 'Classe', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'descricao': 'descricao', 'm2': 'm2', 'data_inclusao': 'Data de Inclusão', 'status_leilao': 'Região', 'processo': 'Processo', });
...
lyr_TCRACETESBPARCELAMENTO23unid_350.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'proc_cetesb': 'Processo CETESB nº. (e-Ambiente)', });
lyr_TCRACETESBPARCELAMENTO23unid_351.set('fieldAliases', {'fid': 'fid', 'Name': 'Nome', 'Area': 'Área (m²)', 'quant': 'Quantidade de mudas', 'proc_cetesb': 'proc_cetesb', });
...
lyr_ARORemanescentesFlorestais_5.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AROreadeAmortecimento_6.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AROFaixadeCuestas_7.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AROAPP_8.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_ARAIncongrunciasemAPP_9.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_ARAETELagoas_10.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_ARAAterros_11.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AODreaUrbanaConsolidada_12.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AODBaixaDensidadeNvel3_13.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AODBaixaDensidadeNvel2_14.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AODBaixaDensidadeNvel1_15.set('fieldImages', {'fid': '', 'Subclasse': '', 'Área (m²': '', 'Classe': '', 'desc_subcl': '', 'desc_class': '', 'SUM_area': '', 'FIRST_AI': '', 'layer': '', 'path': '', });
lyr_AODAUSFase2_16.set('fieldImages', {'fid': 'TextEdit', 'Subclasse': '', 'Área (m²': '', 'Classe': 'TextEdit', 'desc_subcl': '', 'desc_class': '', 'SUM_area': 'TextEdit', 'FIRST_AI': 'TextEdit', 'layer': '', 'path': '', });
lyr_AODAUSFase1_17.set('fieldImages', {'fid': 'TextEdit', 'Subclasse': '', 'Área (m²': '', 'Classe': 'TextEdit', 'desc_subcl': '', 'desc_class': '', 'SUM_area': 'TextEdit', 'FIRST_AI': 'TextEdit', 'layer': '', 'path': '', });
...
lyr_ParqueAmbientalLuprcioTaveira_87.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParqueAmbientalLuprcioTaveira_88.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParqueAmbientalSebastioAlvesBranquinhoBosquedosAngicos_89.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParqueAmbientalSebastioAlvesBranquinhoBosquedosAngicos_90.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParquedeExposiesFernandoCosta_91.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParquedeExposiesFernandoCosta_92.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParqueCaxambu_93.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParqueCaxambu_94.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ComplexoPoliesportivo_95.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ComplexoPoliesportivo_96.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParquedosTrabalhadores_97.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_ParquedosTrabalhadores_98.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_JardimZoobotnico_99.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
lyr_JardimZoobotnico_100.set('fieldImages', {'fid': '', 'Name': '', 'descriptio': '', 'Nome': '', 'Descriçã': '', 'layer': '', 'path': '', });
...
lyr_ClasseVB_307.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseVA_308.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseIVC_309.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseIVB_310.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseIVA_311.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseIIIC_312.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseIIIB_313.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseIIIA_314.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseII_315.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
lyr_ClasseI_316.set('fieldImages', {'fid': '', 'classe': '', 'risco_eros': '', 'suscetibil': '', 'uso_solo': '', 'setores_re': '', 'solos_pred': '', 'substrato_': '', 'processos_': '', 'recomendac': '', });
...
lyr_readeUsoEspecial276unid271190268m_327.set('fieldImages', {'fid': 'TextEdit', 'Classe': 'TextEdit', 'Bairro': 'TextEdit', 'Nº Cadastro Imobiliário': 'TextEdit', 'Código da Região': 'TextEdit', '1ª Semana': 'TextEdit', '2ª Semana': 'TextEdit', '3ª Semana': 'TextEdit', '4ª Semana': 'TextEdit', '5ª Semana': 'TextEdit', 'descricao': '', 'm2': 'TextEdit', 'data_inclusao': '', 'status_leilao': '', 'processo': '', });
...
lyr_TCRACETESBPARCELAMENTO23unid_350.set('fieldImages', {'fid': '', 'Name': '', 'Area': '', 'quant': '', 'proc_cetesb': '', });
lyr_TCRACETESBPARCELAMENTO23unid_351.set('fieldImages', {'fid': 'TextEdit', 'Name': 'TextEdit', 'Area': 'TextEdit', 'quant': 'Range', 'proc_cetesb': '', });
...
lyr_ARORemanescentesFlorestais_5.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AROreadeAmortecimento_6.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AROFaixadeCuestas_7.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AROAPP_8.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_ARAIncongrunciasemAPP_9.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_ARAETELagoas_10.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_ARAAterros_11.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AODreaUrbanaConsolidada_12.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AODBaixaDensidadeNvel3_13.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AODBaixaDensidadeNvel2_14.set('fieldLabels', {'fid': 'inline label - visible with data', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AODBaixaDensidadeNvel1_15.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AODAUSFase2_16.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_AODAUSFase1_17.set('fieldLabels', {'fid': 'hidden field', 'Subclasse': 'inline label - visible with data', 'Área (m²': 'inline label - visible with data', 'Classe': 'inline label - visible with data', 'desc_subcl': 'inline label - visible with data', 'desc_class': 'inline label - visible with data', 'SUM_area': 'inline label - visible with data', 'FIRST_AI': 'inline label - visible with data', 'layer': 'hidden field', 'path': 'hidden field', });
...
lyr_ParqueAmbientalLuprcioTaveira_87.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParqueAmbientalLuprcioTaveira_88.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParqueAmbientalSebastioAlvesBranquinhoBosquedosAngicos_89.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParqueAmbientalSebastioAlvesBranquinhoBosquedosAngicos_90.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParquedeExposiesFernandoCosta_91.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParquedeExposiesFernandoCosta_92.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParqueCaxambu_93.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParqueCaxambu_94.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ComplexoPoliesportivo_95.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ComplexoPoliesportivo_96.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParquedosTrabalhadores_97.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_ParquedosTrabalhadores_98.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_JardimZoobotnico_99.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
lyr_JardimZoobotnico_100.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'descriptio': 'hidden field', 'Nome': 'inline label - visible with data', 'Descriçã': 'inline label - visible with data', 'layer': 'inline label - visible with data', 'path': 'hidden field', });
...
lyr_LoteamentoFechado115unid52603608m_330.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'descricao': 'inline label - visible with data', 'm2': 'inline label - visible with data', 'data_inclusao': 'hidden field', 'status_leilao': 'no label', 'processo': 'inline label - visible with data', });
lyr_reaVerde1946unid805735618m_331.set('fieldLabels', {'fid': 'hidden field', 'Classe': 'inline label - visible with data', 'Bairro': 'inline label - visible with data', 'Nº Cadastro Imobiliário': 'inline label - visible with data', 'Código da Região': 'inline label - visible with data', '1ª Semana': 'inline label - visible with data', '2ª Semana': 'inline label - visible with data', '3ª Semana': 'inline label - visible with data', '4ª Semana': 'inline label - visible with data', '5ª Semana': 'inline label - visible with data', 'descricao': 'inline label - visible with data', 'm2': 'inline label - visible with data', 'data_inclusao': 'hidden field', 'status_leilao': 'no label', 'processo': 'inline label - visible with data', });
...
lyr_TCRACETESBPARCELAMENTO23unid_350.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - visible with data', 'Area': 'inline label - visible with data', 'quant': 'inline label - visible with data', 'proc_cetesb': 'inline label - visible with data', });
