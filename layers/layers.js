...
var format_ImvelPrivado49unid_190 = new ol.format.GeoJSON();
var features_ImvelPrivado49unid_190 = format_ImvelPrivado49unid_190.readFeatures(json_ImvelPrivado49unid_190, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImvelPrivado49unid_190 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPrivado49unid_190.addFeatures(features_ImvelPrivado49unid_190);
var lyr_ImvelPrivado49unid_190 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPrivado49unid_190, 
                style: style_ImvelPrivado49unid_190,
                popuplayertitle: 'Imóvel Privado (49 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPrivado49unid_190.png" /> Imóvel Privado (49 unid.)'
            });
var format_ImvelPblico112unid_191 = new ol.format.GeoJSON();
var features_ImvelPblico112unid_191 = format_ImvelPblico112unid_191.readFeatures(json_ImvelPblico112unid_191, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImvelPblico112unid_191 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPblico112unid_191.addFeatures(features_ImvelPblico112unid_191);
var lyr_ImvelPblico112unid_191 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPblico112unid_191, 
                style: style_ImvelPblico112unid_191,
                popuplayertitle: 'Imóvel Público (112 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPblico112unid_191.png" /> Imóvel Público (112 unid.)'
            });
...
var group_PontosViciados = new ol.layer.Group({
                                layers: [lyr_LotesImvelPrivado49unid_189,lyr_ImvelPrivado49unid_190,lyr_ImvelPblico112unid_191,],
                                fold: 'close',
...
lyr_ImvelPrivado49unid_190.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'processo_seinfra': 'Processo SEINFRA', 'processo_sms': 'Processo SMS', });
lyr_ImvelPblico112unid_191.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'processo_seinfra': 'Processo SEINFRA', 'processo_mp': 'Pocesso MP', 'processo_smseg': 'Processo SMSEG', 'coordenada_x': 'Coordenada Leste (x)', 'coordenada_y': 'Coordenada Norte (y)', });
...
lyr_ImvelPrivado49unid_190.set('fieldImages', {'fid': 'TextEdit', 'BAIRRO': 'TextEdit', 'RUA': 'TextEdit', 'CADASTRO IMOBILIÁRIO': 'TextEdit', 'CLASSIFICAÇÃO DO IMÓVEL': 'TextEdit', 'FREQUÊNCIA DE LIMPEZA': 'TextEdit', 'QUADRA': 'TextEdit', 'LOTE': 'TextEdit', 'processo_seinfra': '', 'processo_sms': '', });
lyr_ImvelPblico112unid_191.set('fieldImages', {'fid': 'TextEdit', 'BAIRRO': 'TextEdit', 'RUA': 'TextEdit', 'CADASTRO IMOBILIÁRIO': 'TextEdit', 'CLASSIFICAÇÃO DO IMÓVEL': 'TextEdit', 'FREQUÊNCIA DE LIMPEZA': 'TextEdit', 'QUADRA': 'TextEdit', 'LOTE': 'TextEdit', 'processo_seinfra': '', 'processo_mp': '', 'processo_smseg': '', 'coordenada_x': '', 'coordenada_y': '', });
