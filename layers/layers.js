...
var format_LotesImvelPrivado49unid_222 = new ol.format.GeoJSON();
var features_LotesImvelPrivado49unid_222 = format_LotesImvelPrivado49unid_222.readFeatures(json_LotesImvelPrivado49unid_222, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LotesImvelPrivado49unid_222 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LotesImvelPrivado49unid_222.addFeatures(features_LotesImvelPrivado49unid_222);
var lyr_LotesImvelPrivado49unid_222 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LotesImvelPrivado49unid_222, 
                style: style_LotesImvelPrivado49unid_222,
                popuplayertitle: 'Lotes - Imóvel Privado (49 unid.)',
                interactive: true,
                title: '<img src="styles/legend/LotesImvelPrivado49unid_222.png" /> Lotes - Imóvel Privado (49 unid.)'
            });
var format_ImvelPblico112unid_223 = new ol.format.GeoJSON();
var features_ImvelPblico112unid_223 = format_ImvelPblico112unid_223.readFeatures(json_ImvelPblico112unid_223, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImvelPblico112unid_223 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPblico112unid_223.addFeatures(features_ImvelPblico112unid_223);
var lyr_ImvelPblico112unid_223 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPblico112unid_223, 
                style: style_ImvelPblico112unid_223,
                popuplayertitle: 'Imóvel Público (112 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPblico112unid_223.png" /> Imóvel Público (112 unid.)'
            });
var format_ImvelPrivado53unid_224 = new ol.format.GeoJSON();
var features_ImvelPrivado53unid_224 = format_ImvelPrivado53unid_224.readFeatures(json_ImvelPrivado53unid_224, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImvelPrivado53unid_224 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPrivado53unid_224.addFeatures(features_ImvelPrivado53unid_224);
var lyr_ImvelPrivado53unid_224 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPrivado53unid_224, 
                style: style_ImvelPrivado53unid_224,
                popuplayertitle: 'Imóvel Privado (53 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPrivado53unid_224.png" /> Imóvel Privado (53 unid.)'
            });
...
var group_PontosViciados = new ol.layer.Group({
                                layers: [lyr_LotesImvelPrivado49unid_222,lyr_ImvelPblico112unid_223,lyr_ImvelPrivado53unid_224,],
                                fold: 'close',
...
lyr_LotesImvelPrivado49unid_222.set('fieldAliases', {'fid': 'fid', 'quadra': 'QUADRA', 'lote': 'LOTE', 'cadastro_imobiliario': 'CADASTRO IMOBILIÁRIO', });
lyr_ImvelPblico112unid_223.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'processo_seinfra': 'Processo SEINFRA', 'processo_sms': 'Processo SMS', 'processo_mp': 'Pocesso MP', 'processo_smseg': 'Processo SMSEG', 'coordenada_x': 'Coordenada Leste (x)', 'coordenada_y': 'Coordenada Norte (y)', 'outros_processos': 'Outos Processos', });
lyr_ImvelPrivado53unid_224.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'processo_seinfra': 'Processo SEINFRA', 'processo_sms': 'Processo SMS', 'processo_mp': 'Pocesso MP', 'processo_smseg': 'Processo SMSEG', 'coordenada_x': 'Coordenada Leste (x)', 'coordenada_y': 'Coordenada Norte (y)', 'outros_processos': 'Outos Processos', });
