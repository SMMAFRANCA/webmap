...
var format_RESPONSAVEL_EGNALDO217UNID21711881M_547 = new ol.format.GeoJSON();
var features_RESPONSAVEL_EGNALDO217UNID21711881M_547 = format_RESPONSAVEL_EGNALDO217UNID21711881M_547.readFeatures(json_RESPONSAVEL_EGNALDO217UNID21711881M_547, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_RESPONSAVEL_EGNALDO217UNID21711881M_547 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RESPONSAVEL_EGNALDO217UNID21711881M_547.addFeatures(features_RESPONSAVEL_EGNALDO217UNID21711881M_547);
var lyr_RESPONSAVEL_EGNALDO217UNID21711881M_547 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RESPONSAVEL_EGNALDO217UNID21711881M_547, 
                style: style_RESPONSAVEL_EGNALDO217UNID21711881M_547,
                popuplayertitle: 'RESPONSAVEL_EGNALDO (217 UNID. / 217.118,81 M²)',
                interactive: true,
                title: '<img src="styles/legend/RESPONSAVEL_EGNALDO217UNID21711881M_547.png" /> RESPONSAVEL_EGNALDO (217 UNID. / 217.118,81 M²)'
            });
...
var group_ProgramaAdoteUmaPraa = new ol.layer.Group({
                                layers: [lyr_PROG_ADOTE_UMA_PRACA_546,lyr_RESPONSAVEL_EGNALDO217UNID21711881M_547,lyr_RESPONSAVEL_DILU168UNID17025290M_548,],
                                fold: 'close',
...
lyr_RESPONSAVEL_EGNALDO217UNID21711881M_547.set('fieldAliases', {'fid': 'fid', 'ADOTANTE': 'ADOTANTE', 'LOCAL': 'LOCAL', 'POSSUI_PLACA': 'POSSUI_PLACA', 'AREA_M2': 'AREA_M2', 'RESPONSAVEL': 'RESPONSAVEL', 'DATA_CONTRATO': 'DATA_CONTRATO', 'BAIRRO': 'BAIRRO', });
...
lyr_RESPONSAVEL_EGNALDO217UNID21711881M_547.set('fieldImages', {'fid': 'TextEdit', 'ADOTANTE': 'TextEdit', 'LOCAL': 'TextEdit', 'POSSUI_PLACA': 'TextEdit', 'AREA_M2': 'TextEdit', 'RESPONSAVEL': 'TextEdit', 'DATA_CONTRATO': 'DateTime', 'BAIRRO': 'TextEdit', });
...
lyr_RESPONSAVEL_EGNALDO217UNID21711881M_547.set('fieldLabels', {'fid': 'hidden field', 'ADOTANTE': 'inline label - visible with data', 'LOCAL': 'inline label - visible with data', 'POSSUI_PLACA': 'inline label - visible with data', 'AREA_M2': 'inline label - visible with data', 'RESPONSAVEL': 'inline label - visible with data', 'DATA_CONTRATO': 'inline label - visible with data', 'BAIRRO': 'inline label - visible with data', });
