...
var format_readeInfluncia_144 = new ol.format.GeoJSON();
var features_readeInfluncia_144 = format_readeInfluncia_144.readFeatures(json_readeInfluncia_144, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_readeInfluncia_144 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_readeInfluncia_144.addFeatures(features_readeInfluncia_144);
var lyr_readeInfluncia_144 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_readeInfluncia_144, 
                style: style_readeInfluncia_144,
                popuplayertitle: 'Área de Influência',
                interactive: true,
                title: '<img src="styles/legend/readeInfluncia_144.png" /> Área de Influência'
            });
var format_PrpriosPblicos_145 = new ol.format.GeoJSON();
var features_PrpriosPblicos_145 = format_PrpriosPblicos_145.readFeatures(json_PrpriosPblicos_145, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PrpriosPblicos_145 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PrpriosPblicos_145.addFeatures(features_PrpriosPblicos_145);
var lyr_PrpriosPblicos_145 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PrpriosPblicos_145, 
                style: style_PrpriosPblicos_145,
                popuplayertitle: 'Próprios Públicos',
                interactive: true,
                title: '<img src="styles/legend/PrpriosPblicos_145.png" /> Próprios Públicos'
            });
...
lyr_ImvelPrivado49unid_117.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'PROCESSO': 'PROCESSO', });
lyr_ImvelPblico112unid_118.set('fieldAliases', {'fid': 'fid', 'BAIRRO': 'BAIRRO', 'RUA': 'RUA', 'CADASTRO IMOBILIÁRIO': 'CADASTRO IMOBILIÁRIO', 'CLASSIFICAÇÃO DO IMÓVEL': 'CLASSIFICAÇÃO DO IMÓVEL', 'FREQUÊNCIA DE LIMPEZA': 'FREQUÊNCIA DE LIMPEZA', 'QUADRA': 'QUADRA', 'LOTE': 'LOTE', 'PROCESSO': 'PROCESSO', });
...
lyr_readeInfluncia_144.set('fieldAliases', {'fid': 'fid', 'Field1': 'Field1', 'Field2': 'Field2', 'Field3': 'Field3', 'Field4': 'Field4', 'Field5': 'Field5', 'Field6': 'Field6', 'Field7': 'Field7', });
lyr_PrpriosPblicos_145.set('fieldAliases', {'fid': 'fid', 'Field1': 'Field1', 'Field2': 'Field2', 'Field3': 'Field3', 'Field4': 'Field4', 'Field5': 'Field5', 'Field6': 'Field6', 'Field7': 'Field7', });
...
lyr_ImvelPrivado49unid_117.set('fieldImages', {'fid': '', 'BAIRRO': '', 'RUA': '', 'CADASTRO IMOBILIÁRIO': '', 'CLASSIFICAÇÃO DO IMÓVEL': '', 'FREQUÊNCIA DE LIMPEZA': '', 'QUADRA': '', 'LOTE': '', 'PROCESSO': '', });
lyr_ImvelPblico112unid_118.set('fieldImages', {'fid': '', 'BAIRRO': '', 'RUA': '', 'CADASTRO IMOBILIÁRIO': '', 'CLASSIFICAÇÃO DO IMÓVEL': '', 'FREQUÊNCIA DE LIMPEZA': '', 'QUADRA': '', 'LOTE': '', 'PROCESSO': '', });
...
lyr_rvoreImuneaoCorte8unid_140.set('fieldImages', {'fid': '', 'nome_popular': '', 'nome_cientifico': '', 'legislacao': '', });
...
lyr_readeInfluncia_144.set('fieldImages', {'fid': 'TextEdit', 'Field1': 'TextEdit', 'Field2': 'TextEdit', 'Field3': 'TextEdit', 'Field4': 'TextEdit', 'Field5': 'TextEdit', 'Field6': 'TextEdit', 'Field7': 'TextEdit', });
lyr_PrpriosPblicos_145.set('fieldImages', {'fid': '', 'Field1': '', 'Field2': '', 'Field3': '', 'Field4': '', 'Field5': '', 'Field6': '', 'Field7': '', });
...
lyr_ImvelPblico112unid_118.set('fieldLabels', {'fid': 'hidden field', 'BAIRRO': 'inline label - visible with data', 'RUA': 'inline label - visible with data', 'CADASTRO IMOBILIÁRIO': 'inline label - visible with data', 'CLASSIFICAÇÃO DO IMÓVEL': 'hidden field', 'FREQUÊNCIA DE LIMPEZA': 'hidden field', 'QUADRA': 'inline label - visible with data', 'LOTE': 'inline label - visible with data', 'PROCESSO': 'hidden field', });
...
lyr_Voorocas26unid_143.set('fieldLabels', {'fid': 'hidden field', 'Name': 'hidden field', 'ID_PONTO_I': 'hidden field', 'IBGE': 'hidden field', 'MUNIC__PIO': 'hidden field', 'BACIA': 'hidden field', 'LATITUDE': 'hidden field', 'LONGITUDE': 'hidden field', 'SITUA____O': 'hidden field', 'REFER__NCI': 'inline label - visible with data', 'PRIORIDADE': 'hidden field', 'OBSERVA_____': 'hidden field', });
lyr_readeInfluncia_144.set('fieldLabels', {'fid': 'no label', 'Field1': 'no label', 'Field2': 'no label', 'Field3': 'no label', 'Field4': 'no label', 'Field5': 'no label', 'Field6': 'no label', 'Field7': 'no label', });
lyr_PrpriosPblicos_145.set('fieldLabels', {'fid': 'no label', 'Field1': 'no label', 'Field2': 'no label', 'Field3': 'no label', 'Field4': 'no label', 'Field5': 'no label', 'Field6': 'no label', 'Field7': 'no label', });
lyr_PrpriosPblicos_145.on('precompose', function(evt) {
