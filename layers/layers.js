...
var format_PilhaseBaterias16unid_284 = new ol.format.GeoJSON();
var features_PilhaseBaterias16unid_284 = format_PilhaseBaterias16unid_284.readFeatures(json_PilhaseBaterias16unid_284, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_PilhaseBaterias16unid_284 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PilhaseBaterias16unid_284.addFeatures(features_PilhaseBaterias16unid_284);
var lyr_PilhaseBaterias16unid_284 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PilhaseBaterias16unid_284, 
                style: style_PilhaseBaterias16unid_284,
                popuplayertitle: 'Pilhas e Baterias (16 unid.)',
                interactive: true,
                title: '<img src="styles/legend/PilhaseBaterias16unid_284.png" /> Pilhas e Baterias (16 unid.)'
            });
...
lyr_PilhaseBaterias16unid_284.set('fieldAliases', {'fid': 'fid', 'Categoria': 'Categoria', 'Local': 'Local', 'Descrição': 'Descrição', 'Endereço': 'Endereço', 'Contato': 'Contato', });
...
lyr_PilhaseBaterias16unid_284.set('fieldImages', {'fid': 'TextEdit', 'Categoria': 'TextEdit', 'Local': 'TextEdit', 'Descrição': 'TextEdit', 'Endereço': 'TextEdit', 'Contato': 'TextEdit', });
...
lyr_PilhaseBaterias16unid_284.set('fieldLabels', {'fid': 'hidden field', 'Categoria': 'inline label - visible with data', 'Local': 'inline label - visible with data', 'Descrição': 'inline label - visible with data', 'Endereço': 'inline label - visible with data', 'Contato': 'inline label - visible with data', });
