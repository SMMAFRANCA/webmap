...
var format_reaVerde2003unid837108178m_43 = new ol.format.GeoJSON();
var features_reaVerde2003unid837108178m_43 = format_reaVerde2003unid837108178m_43.readFeatures(json_reaVerde2003unid837108178m_43, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_reaVerde2003unid837108178m_43 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_reaVerde2003unid837108178m_43.addFeatures(features_reaVerde2003unid837108178m_43);
var lyr_reaVerde2003unid837108178m_43 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_reaVerde2003unid837108178m_43, 
                style: style_reaVerde2003unid837108178m_43,
                popuplayertitle: 'Área Verde (2003 unid. / 8.371.081,78 m²)',
                interactive: true,
                title: '<img src="styles/legend/reaVerde2003unid837108178m_43.png" /> Área Verde (2003 unid. / 8.371.081,78 m²)'
            });
...
var format_ImvelPblico117unid_249 = new ol.format.GeoJSON();
var features_ImvelPblico117unid_249 = format_ImvelPblico117unid_249.readFeatures(json_ImvelPblico117unid_249, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31983'});
var jsonSource_ImvelPblico117unid_249 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImvelPblico117unid_249.addFeatures(features_ImvelPblico117unid_249);
var lyr_ImvelPblico117unid_249 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImvelPblico117unid_249, 
                style: style_ImvelPblico117unid_249,
                popuplayertitle: 'Imóvel Público (117 unid.)',
                interactive: true,
                title: '<img src="styles/legend/ImvelPblico117unid_249.png" /> Imóvel Público (117 unid.)'
            });
...
var group_PontosViciados = new ol.layer.Group({
                                layers: [lyr_LotesImvelPrivado92unid_248,lyr_ImvelPblico117unid_249,lyr_ImvelPrivado92unid_250,],
                                fold: 'close',
...
var group_reasPblicas = new ol.layer.Group({
                                layers: [lyr_LoteEMDEF10unid218783m_35,lyr_LoteEMDEF10unid_36,lyr_Lote504unid13809703m_37,lyr_Lote504unid_38,lyr_APP169unid238007435m_39,lyr_readeUsoEspecial247unid269765616m_40,lyr_reaInstitucional240unid136439095m_41,lyr_reaPatrimonial33unid15807656m_42,lyr_reaVerde2003unid837108178m_43,],
                                fold: 'close',
...
lyr_reaVerde2003unid837108178m_43.set('fieldAliases', {'id_pk': 'id_pk', 'fid': 'fid', 'Classe': 'Classe', 'Bairro': 'Bairro', 'Nº Cadastro Imobiliário': 'Nº Cadastro Imobiliário', 'Código da Região': 'Código da Região', '1ª Semana': '1ª Semana', '2ª Semana': '2ª Semana', '3ª Semana': '3ª Semana', '4ª Semana': '4ª Semana', '5ª Semana': '5ª Semana', 'Terceirização': 'Terceirização', 'm2': 'm2', });
...
lyr_reaVerde2003unid837108178m_43.set('fieldImages', {'id_pk': '', 'fid': 'TextEdit', 'Classe': 'TextEdit', 'Bairro': 'TextEdit', 'Nº Cadastro Imobiliário': 'TextEdit', 'Código da Região': 'TextEdit', '1ª Semana': 'TextEdit', '2ª Semana': 'TextEdit', '3ª Semana': 'TextEdit', '4ª Semana': 'TextEdit', '5ª Semana': 'TextEdit', 'Terceirização': 'TextEdit', 'm2': 'TextEdit', });
