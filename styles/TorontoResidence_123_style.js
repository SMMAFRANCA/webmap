var size = 0;
var placement = 'point';
function categories_TorontoResidence_123(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement, textAlign, offsetX, offsetY, overflow, repeat) {
    var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
    switch(valueStr) {case 'AREA LAZER':
...
var style_TorontoResidence_123 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_TorontoResidence_123(feature, value, size, resolution, labelText,
