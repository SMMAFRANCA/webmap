var size = 0;
var placement = 'point';
function categories_HELIPONTO_HOSPITAL_REGIONAL_495(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement, textAlign, offsetX, offsetY, overflow, repeat) {
    var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
    switch(valueStr) {
        case 'Aproximação 1 seção 1':
...
var style_HELIPONTO_HOSPITAL_REGIONAL_495 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_HELIPONTO_HOSPITAL_REGIONAL_495(feature, value, size, resolution, labelText,
