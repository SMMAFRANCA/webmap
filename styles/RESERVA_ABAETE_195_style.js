var size = 0;
var placement = 'point';
function categories_RESERVA_ABAETE_195(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case 'QUADRAS':
            return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,255,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.3679999999999999}),fill: new ol.style.Fill({color: 'rgba(222,121,166,0.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
...
var style_RESERVA_ABAETE_195 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_RESERVA_ABAETE_195(feature, value, size, resolution, labelText,
