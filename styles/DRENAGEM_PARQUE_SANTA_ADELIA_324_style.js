var size = 0;
var placement = 'point';
function categories_DRENAGEM_PARQUE_SANTA_ADELIA_324(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case 'DIAMETRO 500':
            return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(139,129,79,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 1.938}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
        ...
        case 'DIAMETRO 700':
            return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(99,12,36,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.603}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
...
var style_DRENAGEM_PARQUE_SANTA_ADELIA_324 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_DRENAGEM_PARQUE_SANTA_ADELIA_324(feature, value, size, resolution, labelText,
