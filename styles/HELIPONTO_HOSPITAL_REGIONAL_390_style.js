var size = 0;
var placement = 'point';
function categories_HELIPONTO_HOSPITAL_REGIONAL_390(feature, value, size, resolution, labelText,
...
var style_HELIPONTO_HOSPITAL_REGIONAL_390 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_HELIPONTO_HOSPITAL_REGIONAL_390(feature, value, size, resolution, labelText,
