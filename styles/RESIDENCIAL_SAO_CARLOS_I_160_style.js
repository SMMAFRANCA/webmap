var size = 0;
var placement = 'point';
function categories_RESIDENCIAL_SAO_CARLOS_I_160(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case 'CICLOVIA':
            return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(255,255,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.3679999999999999}),fill: new ol.style.Fill({color: 'rgba(189,147,17,0.5019607843137255)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
...
var style_RESIDENCIAL_SAO_CARLOS_I_160 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_RESIDENCIAL_SAO_CARLOS_I_160(feature, value, size, resolution, labelText,
