var size = 0;
var placement = 'point';
function categories_DRENAGEM_JARDIM_MARIA_LUIZA_343(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case 'FLUXO':
            return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(127,0,0,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 1.748}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
...
var style_DRENAGEM_JARDIM_MARIA_LUIZA_343 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_DRENAGEM_JARDIM_MARIA_LUIZA_343(feature, value, size, resolution, labelText,
