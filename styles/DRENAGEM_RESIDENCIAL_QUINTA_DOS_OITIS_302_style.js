var size = 0;
var placement = 'point';
function categories_DRENAGEM_RESIDENCIAL_QUINTA_DOS_OITIS_302(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case 'DIAMETRO 1800':
            return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(188,101,103,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 4.028}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
...
var style_DRENAGEM_RESIDENCIAL_QUINTA_DOS_OITIS_302 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_DRENAGEM_RESIDENCIAL_QUINTA_DOS_OITIS_302(feature, value, size, resolution, labelText,
