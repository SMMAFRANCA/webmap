var size = 0;
var placement = 'point';
function categories_DRENAGEM_RECREIO_CAMPO_BELO_325(feature, value, size, resolution, labelText,
...
var style_DRENAGEM_RECREIO_CAMPO_BELO_325 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_DRENAGEM_RECREIO_CAMPO_BELO_325(feature, value, size, resolution, labelText,
