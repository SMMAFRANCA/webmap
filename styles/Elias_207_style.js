var size = 0;
var placement = 'point';
function categories_Elias_207(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'LOTES MISTOS':
...
var style_Elias_207 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Elias_207(feature, value, size, resolution, labelText,
