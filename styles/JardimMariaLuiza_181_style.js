var size = 0;
var placement = 'point';
function categories_JardimMariaLuiza_181(feature, value, size, resolution, labelText,
...
var style_JardimMariaLuiza_181 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_JardimMariaLuiza_181(feature, value, size, resolution, labelText,
