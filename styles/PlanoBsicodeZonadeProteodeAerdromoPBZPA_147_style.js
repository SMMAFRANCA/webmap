var size = 0;
var placement = 'point';
function categories_PlanoBsicodeZonadeProteodeAerdromoPBZPA_147(feature, value, size, resolution, labelText,
...
default:
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(77,120,238,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2.508}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_PlanoBsicodeZonadeProteodeAerdromoPBZPA_147 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_PlanoBsicodeZonadeProteodeAerdromoPBZPA_147(feature, value, size, resolution, labelText,
