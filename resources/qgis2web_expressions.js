...
function exp_label_FazendaPalestina105unid_323_eval_expression(context) {
...
function exp_label_AntigoAterrodaFazendaMunicipalPMsGsAvatz15unid_330_eval_expression(context) {
    // poco || ' - ' || empresa
...
function exp_label_AntigoAterrodaFazendaMunicipalPMsguaAvatz18unid_331_eval_expression(context) {
    // poco || ' - ' || empresa
...
function exp_label_AntigoAterrodaFazendaMunicipalPMsguaGeoAnaltica15unid_332_eval_expression(context) {
    // poco || ' - ' || empresa
